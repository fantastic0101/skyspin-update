...
import (
	...
	"serve/servicehacksaw/hacksaw_1233/internal"
...
var (
  ...
  "playerId": "43e2e9be-c3d5-4a00-a1a4-48e2140ffb80",
  "name": "Demo",
  "languageCode": "en-us",
  "sessionUuid": "14ec8dc9-db96-4258-92d5-c238c8ab0184",
  ...
  "bonusGames": [
    ...
    {
      "bonusGameId": "mod_2_expand",
      "betCostMultiplier": "20",
      "expectedRtp": 96.34
    },
    {
      "bonusGameId": "mod_3_expand",
      "betCostMultiplier": "50",
      "expectedRtp": 96.31
    },
    {
      "bonusGameId": "freespins",
      "betCostMultiplier": "110",
      "expectedRtp": 96.2
    },
    {
      "bonusGameId": "progressive_fs",
  ...
  "dialog": null,
  "customData": null,
  "serverTime": "2025-04-18T07:40:11Z"
}`
)
