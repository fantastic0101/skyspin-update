...
import (
	...
	"serve/servicehacksaw/hacksaw_1213/internal"
...
var (
  ...
  "playerId": "e780eae7-b106-4436-90f2-24ae2fc85dd4",
  "name": "Demo",
  "languageCode": "en-us",
  "sessionUuid": "01063bcf-77a6-4d84-8a69-05f6291d1e1e",
  ...
  "bonusGames": [
    ...
    {
      "bonusGameId": "freespins_book",
      "betCostMultiplier": "100",
      "expectedRtp": 96.39
    },
    {
      "bonusGameId": "freespins_clock",
      "betCostMultiplier": "200",
      "expectedRtp": 96.25
    },
    {
      "bonusGameId": "freespins_book2",
      "betCostMultiplier": "200",
      "expectedRtp": 96.35
    },
    {
      "bonusGameId": "freespins_book3",
  ...
  "dialog": null,
  "customData": null,
  "serverTime": "2025-04-18T06:53:58Z"
}`
)
