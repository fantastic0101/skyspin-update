...
var GBuckets = NewBuckets([]*Bound{{Group: 0, Min: -1, Max: 0, HasGame: false, Type: GameTypeNormal},
	...
	{Group: 6, Min: 100, Max: 99999, HasGame: false, Type: GameTypeNormal},
	{Group: 7, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod1},
	{Group: 7, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod1},
	{Group: 7, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod1},
	{Group: 7, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod1},
	{Group: 8, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod2},
	{Group: 8, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod2},
	{Group: 8, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod2},
	{Group: 8, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod2},
	{Group: 9, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod3},
	{Group: 9, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod3},
	{Group: 9, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod3},
	{Group: 9, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod3},
	{Group: 10, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod4},
	{Group: 10, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod4},
	{Group: 10, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod4},
	{Group: 10, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod4},
	{Group: 11, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod5},
	{Group: 11, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod5},
	{Group: 11, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod5},
	{Group: 11, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod5},
	{Group: 12, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod6},
	{Group: 12, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod6},
	{Group: 12, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod6},
	{Group: 12, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod6},
	{Group: 13, Min: -1, Max: 1, HasGame: true, Type: GameTypeMod7},
	{Group: 13, Min: 1, Max: 30, HasGame: true, Type: GameTypeMod7},
	{Group: 13, Min: 30, Max: 40, HasGame: true, Type: GameTypeMod7},
	{Group: 13, Min: 40, Max: 99999, HasGame: true, Type: GameTypeMod7},
})
...
func GetBuyMinBucketId(mod int) int {
	minRate, maxRate := float64(0), float64(10)
	for _, b := range GBuckets.Bounds {
		if b.Min >= minRate && b.Max <= maxRate && b.Type == BoundType(mod) {
			return b.ID
		}
	}
