...
func init() {
	jiliut.RegRpc("/history/ctk/get-history-record", get_history_record)

	jiliut.RegRpc("/history/ctk/get-single-round-log-summary/", get_single_round_log_summary)

	jiliut.RegRpc("/history/ctk/get-log-plate-info/", get_log_plate_info)
}
