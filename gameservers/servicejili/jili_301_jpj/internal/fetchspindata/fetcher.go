...
import (
	...
	"serve/servicejili/jili_301_jpj/internal"
	"serve/servicejili/jili_301_jpj/internal/gendata"
	"serve/servicejili/jili_301_jpj/internal/message"
...
func (f *Fetcher) run() bool {
	...
	for ; ; time.Sleep(time.Second) {
		...
		var jpjData message.SpinAck
		lo.Must0(proto.Unmarshal(spinResponse.Data, &jpjData))
		...
		doc := &models.RawSpin{
			...
			Type:     f.ty,
			HasGame:  len(JpjData.GetRoundQueue()) > 1,
			JpjData:  &mw3Data,
			UtData:   &spinResponse,
			Selected: true,
		}
