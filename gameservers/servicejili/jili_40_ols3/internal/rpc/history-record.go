...
func init() {
	jiliut.RegRpc("/history/ols3/get-history-record", get_history_record)

	jiliut.RegRpc("/history/ols3/get-single-round-log-summary/", get_single_round_log_summary)

	jiliut.RegRpc("/history/ols3/get-log-plate-info/", get_log_plate_info)
}
