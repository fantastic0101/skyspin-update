...
import (
	...
	"serve/comm/ut"
	"serve/servicejili/jili_37_sweetheart5/internal"
...
func spin(pid int64, data []byte, ps *nats.Msg) (ret protoreflect.ProtoMessage, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		//游戏内部数据
		sweetheart5Data := doc.Sweetheart5Data
		for _, pl := range sweetheart5Data.Plate {
		...
		//awrard := (*sweetheart5Data.Award) * int32(bet) / internal.BaseBet
		//sweetheart5Data.Award = &awrard
		// ut.FloatPtrMul(sweetheart5Data.PlateWin, bet)
		// ut.FloatPtrMul(sweetheart5Data.MultWin, bet)
		// ut.FloatPtrMul(sweetheart5Data.ExtraWin, bet)
		// ut.FloatPtrMul(sweetheart5Data.RespinWin, bet)
		...
		// sweetheart5Data.NowMoney = proto.Float64(ut.Gold2Money(balanceGold))
		// jiliUtData.PostMoney = sweetheart5Data.NowMoney
		jiliUtData.PostMoney = proto.Float64(ut.Gold2Money(balanceGold))
		jiliUtData.Data, _ = proto.Marshal(sweetheart5Data)
