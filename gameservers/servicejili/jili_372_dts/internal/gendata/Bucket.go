...
func NewBuckets() *Buckets {
	bounds := []*Bound{
		...
		// Group 27
		{Group: 27, Min: -1, Max: 0, PoolCost: 0, HasGame: true, Type: 3},

		// Group 28
		{Group: 28, Min: 0, Max: 10, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 28, Min: 10, Max: 20, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 28, Min: 20, Max: 30, PoolCost: 0, HasGame: true, Type: 3},

		// Group 29
		{Group: 29, Min: 30, Max: 50, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 29, Min: 50, Max: 80, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 29, Min: 80, Max: 100, PoolCost: 0, HasGame: true, Type: 3},

		// Group 30
		{Group: 30, Min: 100, Max: 150, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 30, Min: 150, Max: 200, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 30, Min: 200, Max: 250, PoolCost: 0, HasGame: true, Type: 3},

		// Group 31
		{Group: 31, Min: 250, Max: 300, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 31, Min: 300, Max: 350, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 31, Min: 350, Max: 500, PoolCost: 0, HasGame: true, Type: 3},
		{Group: 31, Min: 500, Max: 99999, PoolCost: 0, HasGame: true, Type: 3},

		// Group 32
		{Group: 32, Min: -1, Max: 0, PoolCost: 0, HasGame: true, Type: 4},

		// Group 33
		{Group: 33, Min: 0, Max: 10, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 33, Min: 10, Max: 20, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 33, Min: 20, Max: 30, PoolCost: 0, HasGame: true, Type: 4},

		// Group 34
		{Group: 34, Min: 30, Max: 50, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 34, Min: 50, Max: 80, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 34, Min: 80, Max: 100, PoolCost: 0, HasGame: true, Type: 4},

		// Group 35
		{Group: 35, Min: 100, Max: 150, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 35, Min: 150, Max: 200, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 35, Min: 200, Max: 250, PoolCost: 0, HasGame: true, Type: 4},

		// Group 36
		{Group: 36, Min: 250, Max: 300, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 36, Min: 300, Max: 350, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 36, Min: 350, Max: 500, PoolCost: 0, HasGame: true, Type: 4},
		{Group: 36, Min: 500, Max: 99999, PoolCost: 0, HasGame: true, Type: 4},
	}
