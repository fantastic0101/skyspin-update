...
const (
	...
	GameTypeExtra     = 1 // 额外投注，1.5倍
	GameTypeExtraPlus = 2 // 额外投注，3.0倍
)
...
func NewBuckets() *Buckets {
	bounds := []*Bound{
		...
		{Group: 8, Min: 50, Max: 80, PoolCost: 0, HasGame: true, Type: 0},
		...
		{Group: 12, Min: -1, Max: 0, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 13, Min: 0, Max: 0.25, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 13, Min: 0.25, Max: 0.5, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 13, Min: 0.5, Max: 1, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 14, Min: 1, Max: 2, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 14, Min: 2, Max: 3, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 14, Min: 3, Max: 4, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 15, Min: 4, Max: 6, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 15, Min: 6, Max: 8, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 15, Min: 8, Max: 10, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 15, Min: 10, Max: 15, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 16, Min: 15, Max: 20, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 16, Min: 20, Max: 30, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 16, Min: 30, Max: 40, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 16, Min: 40, Max: 60, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 17, Min: 60, Max: 80, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 17, Min: 80, Max: 100, PoolCost: 0, HasGame: false, Type: 1},
		{Group: 17, Min: 100, Max: 99999, PoolCost: 0, HasGame: false, Type: 1},
