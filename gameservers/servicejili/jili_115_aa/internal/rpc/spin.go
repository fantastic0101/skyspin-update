...
func spin(ps *nats.Msg) (ret []byte, err error) {
	...
	var spinReq message.Aa_SpinReq
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		// doc, hitBigAward, forcedKill, err = nextPlayRespObjectID("667a241a509bbeb1e4d25eb6")
		...
		for _, round := range spinAck.RoundQueue {
			for _, awarddata := range round.AwardDataVec {
