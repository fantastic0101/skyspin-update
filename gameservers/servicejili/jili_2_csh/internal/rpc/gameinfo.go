...
func gameinfo(ps *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		var ack = message.Csh_GameInfoAck{
			ArcadeNo:      proto.Int32(944261),
			CanIntoArcade: proto.Bool(true),
			Plate:         []int32{5, 7, 5, 0, 2, 5, 0, 7, 3, 4, 4, 0, 3, 5, 8, 8, 3, 3, 1, 7, 9, 0, 5, 6},
			Prefer:        []*message.Csh_PreferRoundShow{},
			// Test:          proto.Bool(true),
			WalletInfo: []*message.Csh_WalletInfo{
				{
					//CurrencyNumber: proto.Int32(17),
