...
func init() {
	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-history-record", "dp"), get_history_record)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-single-round-log-summary/", "dp"), get_single_round_log_summary)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-log-plate-info/", "dp"), get_log_plate_info)
}
