...
func NewBuckets() *Buckets {
	bounds := []*Bound{
		...
		{Group: 7, Min: -1, Max: 0, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 8, Min: 0, Max: 0.25, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 8, Min: 0.25, Max: 0.5, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 8, Min: 0.5, Max: 1, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 8, Min: 1, Max: 2, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 9, Min: 2, Max: 3, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 9, Min: 3, Max: 4, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 9, Min: 4, Max: 6, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 10, Min: 6, Max: 8, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 10, Min: 8, Max: 10, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 11, Min: 10, Max: 15, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 11, Min: 15, Max: 20, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 12, Min: 20, Max: 30, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 12, Min: 30, Max: 40, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 13, Min: 40, Max: 60, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 13, Min: 60, Max: 80, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 13, Min: 80, Max: 100, PoolCost: 0, HasGame: false, Type: 2},
		{Group: 14, Min: 100, Max: 99999, PoolCost: 0, HasGame: false, Type: 2},
	}
