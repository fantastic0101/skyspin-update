...
import (
	...
	"serve/servicejili/jili_303_mp2/internal/gendata"
	"serve/servicejili/jili_303_mp2/internal/message"
	"serve/servicejili/jili_303_mp2/internal/models"
...
type Fetcher struct {
	...
	launchUrl    *url.URL
	spinUrl      *url.URL
	gameReq      *message.Mp2_GameReqData
	historyToken string
}
...
func newFetcher(username string, coll *mongo.Collection, ty int) *Fetcher {
	...
	var loginDataReq = message.Mp2_LoginDataReq{
	...
	var gameloginResData message.Mp2_ResData
...
func (f *Fetcher) run() {
	...
	for ; ; time.Sleep(time.Second) {
		var spinResData message.Mp2_ResData
		...
		var spinAll message.Mp2_SpinAllData
