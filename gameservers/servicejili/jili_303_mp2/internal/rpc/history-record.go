...
func init() {
	jiliut.RegRpc("/history/mp2/get-history-record", get_history_record)

	jiliut.RegRpc("/history/mp2/get-single-round-log-summary/", get_single_round_log_summary)

	jiliut.RegRpc("/history/mp2/get-log-plate-info/", get_log_plate_info)
}
