...
func nextPlayResp(player *models.Player, bet int64, selfPoolGold int64, ty int, App *redisx.AppStore) (playResp *models.RawSpin, hitBigAward, forcedKill bool, err error) {
	...
	if false {
		...
		// objectId, _ := primitive.ObjectIDFromHex("667a2afdeb11ded1615936b1")
		// match["id"] = objectId
