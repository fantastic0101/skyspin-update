...
func init() {
	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-history-record", "af"), get_history_record)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-single-round-log-summary/", "af"), get_single_round_log_summary)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-log-plate-info/", "af"), get_log_plate_info)
}
