...
func main() {
	...
	for i := 0; i < 5; i++ {
		go func(id int) {
			var num int
			for {
				newFetcher(fmt.Sprintf("%d_176123456_%d_%d", internal.GameNo, id, num), coll).run()
...
// 	var loginDataReq = message.Cny_LoginDataReq{
...
// 	var gameloginResData message.Cny_ResData
...
// 		Encode: jiliut.ProtoEncode(&message.Cny_SpinReq{
// 			Bet: proto.Float64(internal.BaseBet),
// 		}),
// 	}

// 	for ; ; time.Sleep(time.Second) {
// 		var spinResData message.Cny_ResData
