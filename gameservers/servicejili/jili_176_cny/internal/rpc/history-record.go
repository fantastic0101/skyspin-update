...
func init() {
	jiliut.RegRpc("/history/cny/get-history-record", get_history_record)

	jiliut.RegRpc("/history/cny/get-single-round-log-summary/", get_single_round_log_summary)

	jiliut.RegRpc("/history/cny/get-log-plate-info/", get_log_plate_info)
}
