...
func spin(ps *nats.Msg) (ret []byte, err error) {
	var gameReq message.Cny_GameReqData
	...
	var spinReq message.Cny_SpinReq
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		ut.FloatPtrDiv(spinAck.FreeTotalWin, internal.BaseBet)
		...
		var spinAll = message.Cny_SpinAllData{
			Info: []*message.Cny_SpinAck{
				spinAck,
			}}
