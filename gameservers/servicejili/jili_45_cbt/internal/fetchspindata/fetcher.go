...
type Fetcher struct {
	...
	launchUrl    *url.URL
	spinUrl      *url.URL
	gameReq      *message.Cbt_GameReqData
	historyToken string
}
...
func newFetcher(username string, coll *mongo.Collection) *Fetcher {
	...
	var loginDataReq = message.Cbt_LoginDataReq{
	...
	var gameloginResData message.Cbt_ResData
...
func (f *Fetcher) run() {
	...
	for ; ; time.Sleep(time.Second) {
		var spinResData message.Cbt_ResData
