			...
			WalletInfo: []*jiliUtMessage.Server_WalletInfo{
				{
					...
					Decimal:        proto.Int32(4),
					Rate:           proto.Float64(5.75),
			...
			Mall: []*jiliUtMessage.Server_MallInfo{
				{
					...
					MaxBet:   proto.Float64(100 * currencyMulti),
					PriceOdd: proto.Float64(77.5),
