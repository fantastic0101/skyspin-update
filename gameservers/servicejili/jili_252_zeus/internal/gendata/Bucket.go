...
func NewBuckets() *Buckets {
	bounds := []*Bound{
		...
		{Group: 4, Min: 20, Max: 30, PoolCost: 5, HasGame: false, Type: 0},
		{Group: 4, Min: 30, Max: 40, PoolCost: 5, HasGame: false, Type: 0},
		{Group: 5, Min: 40, Max: 60, PoolCost: 6, HasGame: false, Type: 0},
		{Group: 5, Min: 60, Max: 80, PoolCost: 8, HasGame: false, Type: 0},
		{Group: 5, Min: 80, Max: 100, PoolCost: 10, HasGame: false, Type: 0},
		{Group: 6, Min: 100, Max: 99999, PoolCost: 50, HasGame: false, Type: 0},
		{Group: 7, Min: -1, Max: 0, PoolCost: 0, HasGame: true, Type: 0},
		{Group: 7, Min: 0, Max: 10, PoolCost: 0, HasGame: true, Type: 0},
		{Group: 8, Min: 10, Max: 20, PoolCost: 0, HasGame: true, Type: 0},
		{Group: 8, Min: 20, Max: 30, PoolCost: 0, HasGame: true, Type: 0},
		{Group: 8, Min: 30, Max: 50, PoolCost: 8, HasGame: true, Type: 0},
		{Group: 8, Min: 50, Max: 80, PoolCost: 10, HasGame: true, Type: 0},
		{Group: 9, Min: 80, Max: 100, PoolCost: 10, HasGame: true, Type: 0},
		{Group: 9, Min: 100, Max: 150, PoolCost: 20, HasGame: true, Type: 0},
		{Group: 10, Min: 150, Max: 200, PoolCost: 30, HasGame: true, Type: 0},
		{Group: 10, Min: 200, Max: 250, PoolCost: 30, HasGame: true, Type: 0},
		{Group: 11, Min: 250, Max: 99999, PoolCost: 50, HasGame: true, Type: 0},
		{Group: 12, Min: -1, Max: 0, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 12, Min: 0, Max: 10, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 13, Min: 10, Max: 20, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 13, Min: 20, Max: 30, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 13, Min: 30, Max: 50, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 13, Min: 50, Max: 80, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 14, Min: 80, Max: 100, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 14, Min: 100, Max: 150, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 15, Min: 150, Max: 200, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 15, Min: 200, Max: 250, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 16, Min: 250, Max: 300, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 16, Min: 300, Max: 350, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 16, Min: 350, Max: 500, PoolCost: 0, HasGame: true, Type: 1},
		{Group: 17, Min: 500, Max: 99999, PoolCost: 0, HasGame: true, Type: 1},
	}
