...
func LoadCombineData() (err error) {
	...
	bucketConfig := map[int]*bucketGroups{
		ppcomm.BucketHeartBeat:      {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketWave:           {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketGov:            {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketMix:            {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketStable:         {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketHighAward:      {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
		ppcomm.BucketSuperHighAward: {makeSlice(), makeSlice(), makeSlice(), makeSlice(), makeSlice()},
	}
	//var (
	...
	buckets := make([]map[int][][]primitive.ObjectID, 5)
