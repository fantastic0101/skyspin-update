...
func init() {
	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-history-record", "dl"), get_history_record)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-single-round-log-summary/", "dl"), get_single_round_log_summary)

	jiliut.RegRpc(fmt.Sprintf("/history/%s/get-log-plate-info/", "dl"), get_log_plate_info)
}
