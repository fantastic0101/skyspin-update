...
import (
	...
	"serve/servicejili/jili_136_samba/internal/gendata"
	"serve/servicejili/jili_136_samba/internal/message"
	"serve/servicejili/jili_136_samba/internal/models"
...
type Fetcher struct {
	...
	launchUrl    *url.URL
	spinUrl      *url.URL
	gameReq      *message.Samba_GameReqData
	historyToken string
	token        string
}
...
func newFetcher(username string, coll *mongo.Collection, ty int) *Fetcher {
	...
	var loginDataReq = message.Samba_LoginDataReq{
	...
	var gameloginResData message.Samba_ResData
	...
	f.gameReq = &message.Samba_GameReqData{
		Token: proto.String(token),
		Aid:   proto.Int32(tokenST.Profile.Aid),
		Apiid: proto.Int32(tokenST.Profile.ApiId),
		// Encode: lo.Must(proto.Marshal(&spinReq)),
		Encode: jiliut.ProtoEncode(&message.Samba_SpinReq{
			Bet:     proto.Float64(1),
			Extra:   lo.Ternary(ty == internal.GameTypeExtra, proto.Int32(1), nil),
			MallBet: lo.Ternary(ty == internal.GameTypeGame, proto.Float64(48.5), nil),
			MallID:  lo.Ternary(ty == internal.GameTypeGame, proto.Int32(50), nil),
		}),
	}
	return f
}
...
func (f *Fetcher) run() {
	...
	for {
		...
		var spinResData message.Samba_ResData
		...
		var spinAll message.Samba_SpinAllData
