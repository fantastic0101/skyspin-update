...
func spin(pid int64, data []byte, ps *nats.Msg) (ret protoreflect.ProtoMessage, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		ut.FloatPtrMul(srData.TotalWin, bet)
		...
		srData.NowMoney = proto.Float64(ut.Gold2Money(balanceGold))
		jiliUtData.PostMoney = srData.NowMoney
		jiliUtData.Data, _ = proto.Marshal(srData)
		...
		his.PostMoney = ut.Ftoa(srData.GetNowMoney())
