...
import (
	...
	"serve/comm/ut"
	"serve/servicejili/jili_180_loe/internal"
	"serve/servicejili/jili_180_loe/internal/models"
...
func spin(pid int64, data []byte, ps *nats.Msg) (ret protoreflect.ProtoMessage, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		if isBuy {
			...
			mul := 40.5
			costGold = ut.Money2Gold(bet * mul)
		}
		...
		jiliUtData.Data, _ = proto.Marshal(loeData)
