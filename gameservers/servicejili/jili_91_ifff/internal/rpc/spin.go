...
func spin(pid int64, data []byte, ps *nats.Msg) (ret protoreflect.ProtoMessage, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *models.Player) error {
		...
		doc, hitBigAward, forcedKill, buyKill, err = nextPlayResp(plr, gold, selfPoolGold, false, App)
		if err != nil {
		...
		ut.FloatPtrMul(ifffData.TotalWin, bet)
		...
		ifffData.NowMoney = proto.Float64(ut.Gold2Money(balanceGold))
		jiliUtData.PostMoney = ifffData.NowMoney
		jiliUtData.Data, _ = proto.Marshal(ifffData)
		...
		his.PostMoney = ut.Ftoa(ifffData.GetNowMoney())
