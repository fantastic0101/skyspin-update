	...
	combine := Combine{
		{
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(10, 15, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(15, 20, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(20, 30, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(30, 40, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(40, 60, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(60, 80, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(80, 100, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
			...
			Meta: []CombineMeta{
				{
					BucketIds: GetBucketIds(100, 99999, false, GameTypeNormal),
					Count:     1,
				}, {
					BucketIds: getIdsNoReward(GameTypeNormal),
					Count:     6,
