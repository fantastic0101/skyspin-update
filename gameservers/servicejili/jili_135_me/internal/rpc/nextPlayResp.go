...
func nextPlayResp(player *models.Player, bet int64, selfPoolGold int64, isBuy bool, ty int, App *redisx.AppStore) (playResp *models.RawSpin, hitBigAward, forcedKill, buyKill bool, err error) {
