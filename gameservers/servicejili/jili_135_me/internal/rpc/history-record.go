...
func init() {
	jiliut.RegRpc("/history/me/get-history-record", get_history_record)

	jiliut.RegRpc("/history/me/get-single-round-log-summary/", get_single_round_log_summary)

	jiliut.RegRpc("/history/me/get-log-plate-info/", get_log_plate_info)
}
