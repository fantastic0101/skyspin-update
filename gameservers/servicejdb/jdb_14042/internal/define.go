...
const (
	GameID        = "jdb_14042" //游戏ID
	Line          = 1           //游戏固定倍数，1/20
	Double        = 1.2         //开启了倍率下注，这个游戏不存在倍率下注，部分游戏是1.25
	BetMin        = 1           //最小下注金额
	BetMax        = 3000        //最大下注金额
...
func GetFreeMultiply() map[string]int {

	return map[string]int{
		"BuyFeature_01": FreeMultiply1,
		"BuyFeature_02": FreeMultiply2,
	}
}
