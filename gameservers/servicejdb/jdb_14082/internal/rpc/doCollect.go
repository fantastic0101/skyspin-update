...
//	"serve/comm/ut"
//	"serve/servicejdb/jdb_14082/internal"
//)
//
//func init() {
//	jdbcomm.RegRpc("doCollect", doCollect)
//}
//
//var (
//	sampleCollect = jdbcomm.ParseVariables(`balance_cash=1,009,701.65&balance_bonus=0.00&na=s&stime=1727072800469&sver=5&counter=4&ntp=-1.00`)
//)
//
...
//	// ntp=-1.60
//
//	ps := jdbcomm.ParseVariables(string(msg.Data))
//	//fmt.Println(ps)
//
//	var pid int64
...
//			jdbcomm.InsertBetHistoryEvery(plr, 0, false, false, ps, info, curItem.Key, curItem.Symbol, 0, primitive.ObjectID{}, sampleDoInit.Encode(), "")
//		}
//
//		plr.LastData = info
...
//		}
//
//		jdbcomm.SetRoundID(0)
//		jdbcomm.SetTurnIndex(0)
//
//		if msg.Header != nil && msg.Header.Get("jump_log") != "1" {
