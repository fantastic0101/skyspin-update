...
//}
//
//func hgetCombine(_ mux.EmptyParams, ret *jdbcomm.Combine) (err error) {
...
//}
//
//func getCombine() (combine jdbcomm.Combine, err error) {
...
//	}
//
//	var tmpcombine jdbcomm.Combine
//	err = cursor.All(context.TODO(), &tmpcombine)
//	if err != nil {
//		return
//	}
//
//	combine = jdbcomm.NewCombine(GetCombine())
