...
import (
	...
	"serve/servicejdb/jdb_8047/internal"
	"serve/servicejdb/jdb_8047/internal/gendata"
	_ "serve/servicejdb/jdb_8047/internal/rpc"
...
func test() {
	...
	//		updateData := bson.M{"$set": bson.M{"times": result.Times / 10}}
