...
import (
	...
	"serve/comm/ut"
	"serve/servicejdb/jdb_14093/internal"
	"serve/servicejdb/jdb_14093/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *jdbcomm.Player) error {
		...
		case "ExtraBet_01":
			Multi = curItem.Multi * internal.Line * 1.5
		}
		// 参数处理
		...
		data.SetInt("gameSeq", int(sf.NextID()/100000))
