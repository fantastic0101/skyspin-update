...
import (
	...
	"serve/comm/db"
	"serve/comm/redisx"
	"serve/servicejdb/jdb_14054/internal"
...
var (
	sampleDoInit = `{"maxBet":9223372036854775807,"defaultWaysBetIdx":-1,"singleBetCombinations":{"10_10_1_NoExtraBet":10,"10_1_1_NoExtraBet":1,"10_2_1_NoExtraBet":2,"10_4_1_NoExtraBet":4,"10_5_1_NoExtraBet":5},"minBet":0,"gambleTimes":0,"defaultLineBetIdx":0,"defaultConnectBetIdx":-1,"defaultQuantityBetIdx":-1,"gameFeatureCount":3,"executeSetting":{"settingId":"v3_14054_05_01_001","betSpecSetting":{"paymentType":"PT_001","extraBetTypeList":["NoExtraBet"],"betSpecification":{"lineBetList":[1,2,4,5,10],"betLineList":[1],"betType":"LineGame"}},"gameStateSetting":[{"gameStateType":"GS_112","frameSetting":{"screenColumn":3,"screenRow":1,"wheelUsePattern":"Dependent"},"tableSetting":{"tableCount":2,"tableHitProbability":[1.0,0.0],"wheelData":[[{"wheelLength":48,"noWinIndex":[0],"wheelData":[3,7,4,0,5,6,0,8,8,4,0,7,6,5,0,3,0,7,6,4,3,5,0,8,8,3,4,7,0,6,5,0,4,7,6,0,3,5,0,8,0,6,8,7,0,5,4,3]},{"wheelLength":14,"noWinIndex":[0],"wheelData":[8,5,0,4,6,3,1,7,0,8,6,6,6,7]},{"wheelLength":48,"noWinIndex":[0],"wheelData":[8,3,4,7,0,6,5,0,4,7,6,0,3,5,0,8,0,6,8,7,0,5,4,3,3,7,4,0,5,6,0,8,8,4,0,7,6,5,0,3,0,7,6,4,3,5,0,8]}],[{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]},{"wheelLength":35,"noWinIndex":[0],"wheelData":[6,1,8,3,1,8,7,1,4,1,8,6,7,1,5,6,7,1,5,8,7,1,8,6,1,8,7,1,7,5,1,8,6,0,6]},{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]}]]},"symbolSetting":{"symbolCount":10,"symbolAttribute":["Wild_01","FreeGame_01","FreeGame_02","M1","M2","M3","M4","M5","M6","M7"],"payTable":[[0,0,200],[0,0,0],[0,0,0],[0,0,30],[0,0,20],[0,0,15],[0,0,8],[0,0,5],[0,0,2],[0,0,0]],"mixGroupCount":0,"mixGroupSetting":[]},"lineSetting":{"maxBetLine":1,"lineTable":[[0,0,0]]},"gameHitPatternSetting":{"gameHitPattern":"LineGame_LeftToRight","maxEliminateTimes":0},"specialFeatureSetting":{"specialFeatureCount":1,"specialHitInfo":[{"specialHitPattern":"HP_95","triggerEvent":"Trigger_01","basePay":0}]},"progressSetting":{"triggerLimitType":"RoundLimit","stepSetting":{"defaultStep":1,"addStep":0,"maxStep":1},"stageSetting":{"defaultStage":1,"addStage":0,"maxStage":1},"roundSetting":{"defaultRound":1,"addRound":0,"maxRound":1}},"displaySetting":{"readyHandSetting":{"readyHandLimitType":"NoReadyHandLimit","readyHandCount":0}},"extendSetting":{"initialChooseTableIndex":1,"respinProbability":0.311,"targetScreen":[[0],[9],[0]],"respinFlag":false,"respinTableWeight":[1],"respinTableChoose":[2],"respinColumnIndex":1,"dampInfoRange":2,"emptySymbolID":9}},{"gameStateType":"GS_113","frameSetting":{"screenColumn":3,"screenRow":1,"wheelUsePattern":"Dependent"},"tableSetting":{"tableCount":4,"tableHitProbability":[1.0,0.0,0.0,0.0],"wheelData":[[{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]},{"wheelLength":20,"noWinIndex":[0],"wheelData":[3,4,5,6,7,8,4,5,6,7,8,5,6,7,8,6,7,8,7,8]},{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]}],[{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]},{"wheelLength":25,"noWinIndex":[0],"wheelData":[3,4,2,5,6,8,2,7,8,6,5,4,8,5,7,6,2,7,8,7,8,2,7,8,7]},{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]}],[{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]},{"wheelLength":62,"noWinIndex":[0],"wheelData":[0,3,4,5,2,2,6,7,8,2,2,6,7,8,2,2,5,7,6,2,2,3,7,8,2,2,7,8,8,2,2,3,3,4,5,2,2,6,7,8,2,2,6,7,8,2,2,5,7,6,2,2,3,7,8,2,2,7,8,8,2,2]},{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]}],[{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]},{"wheelLength":62,"noWinIndex":[0],"wheelData":[0,3,4,5,2,2,6,7,8,2,2,6,7,8,2,2,5,7,6,2,2,3,7,8,2,2,7,8,8,2,2,3,3,4,5,2,2,6,7,8,2,2,6,7,8,2,2,5,7,6,2,2,3,7,8,2,2,7,8,8,2,2]},{"wheelLength":1,"noWinIndex":[0],"wheelData":[0]}]]},"symbolSetting":{"symbolCount":10,"symbolAttribute":["Wild_01","FreeGame_01","FreeGame_02","M1","M2","M3","M4","M5","M6","M7"],"payTable":[[0,0,200],[0,0,0],[0,0,0],[0,0,30],[0,0,20],[0,0,15],[0,0,8],[0,0,5],[0,0,2],[0,0,0]],"mixGroupCount":0,"mixGroupSetting":[]},"lineSetting":{"maxBetLine":1,"lineTable":[[0,0,0]]},"gameHitPatternSetting":{"gameHitPattern":"LineGame_LeftToRight","maxEliminateTimes":0},"specialFeatureSetting":{"specialFeatureCount":1,"specialHitInfo":[{"specialHitPattern":"HP_96","triggerEvent":"Trigger_01","basePay":0}]},"progressSetting":{"triggerLimitType":"RoundLimit","stepSetting":{"defaultStep":1,"addStep":0,"maxStep":1},"stageSetting":{"defaultStage":1,"addStage":0,"maxStage":1},"roundSetting":{"defaultRound":1,"addRound":1,"maxRound":20}},"displaySetting":{"readyHandSetting":{"readyHandLimitType":"NoReadyHandLimit","readyHandCount":0}},"extendSetting":{"dampInfoRange":2,"emptySymbolID":9,"c2SymbolID":2,"dampInfoSymbol":[0,3,4,5,6,7,8],"roundLimit":[5,12,19,20],"chooseTableIndex":[1,2,3,4],"fowardNRound":5,"allRoundOdds":50,"fowardNRoundOdds":20,"oddsHitPattern":[5,5,15]}}],"doubleGameSetting":{"doubleRoundUpperLimit":5,"doubleBetUpperLimit":1000000000,"rtp":0.96,"tieRate":0.1},"boardDisplaySetting":{"winRankSetting":{"BigWin":30,"MegaWin":75,"UltraWin":200}},"gameFlowSetting":{"conditionTableWithoutBoardEnd":[["CD_False","CD_True","CD_False"],["CD_False","CD_False","CD_01"],["CD_False","CD_False","CD_False"]]}},"denoms":[10],"defaultDenomIdx":0,"defaultBetLineIdx":0,"betCombinations":{"10_1_NoExtraBet":10,"1_1_NoExtraBet":1,"2_1_NoExtraBet":2,"4_1_NoExtraBet":4,"5_1_NoExtraBet":5},"gambleLimit":0,"buyFeatureLimit":2147483647,"buyFeature":true,"defaultWaysBetColumnIdx":-1}`
)
