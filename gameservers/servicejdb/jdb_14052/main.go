...
import (
	...
	"serve/servicejdb/jdb_14052/internal"
	"serve/servicejdb/jdb_14052/internal/gendata"
	_ "serve/servicejdb/jdb_14052/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "jdb_14052")
