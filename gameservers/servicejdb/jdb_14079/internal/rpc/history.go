...
//
//func init() {
//	jdbcomm.RegRpc("/gs2c/api/history/v2/play-session/last-items", history_last_items)
//	jdbcomm.RegRpc("/gs2c/api/history/v3/action/children", history_children)
//	jdbcomm.RegRpc("/gs2c/api/history/v2/play-session/by-round", history_by_round)
//}
...
//	var docs []*jdbcomm.RspHistoryData
//
...
//	coll := db.Collection("BetHistory")
//	var doc struct {
//		RoundDetails []*jdbcomm.HistoryDetailsData `bson:"rounddetails"`
//	}
...
//	id := ps.Str("id")
//	coll := db.Collection("BetHistory")
//	var doc *jdbcomm.RspHistoryData
//	//if false {
