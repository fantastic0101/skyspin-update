...
import (
	...
	"serve/comm/db"
	"serve/comm/redisx"
	"serve/servicejdb/jdb_14075/internal"
...
var (
	sampleDoInit = `{"maxBet":9223372036854775807,"defaultWaysBetIdx":-1,"singleBetCombinations":{"10_10_5_NoExtraBet":50,"10_1_5_NoExtraBet":5,"10_2_5_NoExtraBet":10,"10_3_5_NoExtraBet":15,"10_5_5_NoExtraBet":25},"minBet":0,"gambleTimes":0,"defaultLineBetIdx":0,"defaultConnectBetIdx":-1,"defaultQuantityBetIdx":-1,"gameFeatureCount":3,"executeSetting":{"settingId":"v3_14075_05_00_001","betSpecSetting":{"paymentType":"PT_001","extraBetTypeList":["NoExtraBet"],"betSpecification":{"lineBetList":[1,2,3,5,10],"betLineList":[5],"betType":"LineGame"}},"gameStateSetting":[{"gameStateType":"GS_142","frameSetting":{"screenColumn":3,"screenRow":3,"wheelUsePattern":"Dependent"},"tableSetting":{"tableCount":9,"tableHitProbability":[1.0],"wheelData":[[{"wheelLength":53,"noWinIndex":[0],"wheelData":[0,0,0,0,0,0,0,0,2,2,2,5,5,8,8,6,6,6,6,6,4,4,4,4,4,6,6,7,7,7,7,7,7,7,3,3,3,3,1,1,1,8,8,8,8,8,8,4,4,5,5,5,5]},{"wheelLength":53,"noWinIndex":[0],"wheelData":[6,3,1,0,0,0,0,0,2,2,2,2,5,5,6,6,6,6,6,4,4,4,4,5,5,6,6,1,1,1,1,5,5,5,5,5,3,3,3,3,8,8,8,8,8,8,7,7,7,7,7,7,7]},{"wheelLength":53,"noWinIndex":[0],"wheelData":[2,4,4,0,0,0,0,0,0,3,3,3,3,3,7,7,4,4,4,4,6,6,5,5,7,7,7,7,7,8,8,1,1,1,8,8,8,8,8,8,2,2,2,2,6,6,6,6,6,5,5,5,5]}]]},"symbolSetting":{"symbolCount":9,"symbolAttribute":["Wild_01","M1","M2","M3","M4","A","K","Q","J"],"payTable":[[0,0,80],[0,0,25],[0,0,20],[0,0,15],[0,0,7],[0,0,6],[0,0,5],[0,0,4],[0,0,2]],"mixGroupCount":0},"lineSetting":{"maxBetLine":5,"lineTable":[[1,1,1],[0,0,0],[2,2,2],[0,1,2],[2,1,0]]},"gameHitPatternSetting":{"gameHitPattern":"LineGame_LeftToRight","maxEliminateTimes":0},"specialFeatureSetting":{"specialFeatureCount":1,"specialHitInfo":[{"specialHitPattern":"HP_120","triggerEvent":"ReTrigger_01","basePay":0}]},"progressSetting":{"triggerLimitType":"RoundLimit","stepSetting":{"defaultStep":1,"addStep":0,"maxStep":1},"stageSetting":{"defaultStage":1,"addStage":0,"maxStage":1},"roundSetting":{"defaultRound":1,"addRound":1,"maxRound":2}},"displaySetting":{"readyHandSetting":{"readyHandLimitType":"NoReadyHandLimit","readyHandCount":0,"readyHandType":["ReadyHand_01"]}},"extendSetting":{"multipleList":[2,4,3,5,2,4,2,3,5,3,2,10],"multipleWeight":[1854,1265,564,336,69],"multiples":[2,3,4,5,10]}}],"doubleGameSetting":{"doubleRoundUpperLimit":5,"doubleBetUpperLimit":1000000000,"rtp":0.96,"tieRate":0.1},"boardDisplaySetting":{"winRankSetting":{"BigWin":20,"MegaWin":40,"UltraWin":90}},"gameFlowSetting":{"conditionTableWithoutBoardEnd":[["CD_False","CD_True"],["CD_False","CD_False"]]}},"denoms":[10],"defaultDenomIdx":0,"defaultBetLineIdx":0,"betCombinations":{"10_5_NoExtraBet":50,"1_5_NoExtraBet":5,"2_5_NoExtraBet":10,"3_5_NoExtraBet":15,"5_5_NoExtraBet":25},"gambleLimit":0,"buyFeatureLimit":2147483647,"buyFeature":true,"defaultWaysBetColumnIdx":-1}`
)
