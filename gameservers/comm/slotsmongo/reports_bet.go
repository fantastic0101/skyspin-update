...
func addReport(game, appId string, pid, bet, win int64, completed, isBuy, extra bool, bigReward int64) {
	...
	if extra {
		db.AppendE(&incDoc, "extrabetamount", bet)
		db.AppendE(&incDoc, "extrawinamount", win)
	}
	...
	addPayerDailyRetention(dateStr, game, appId, pid)
}
