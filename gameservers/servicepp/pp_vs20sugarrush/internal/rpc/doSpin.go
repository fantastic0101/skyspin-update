...
import (
	...
	"serve/comm/ut"
	"serve/servicepp/pp_vs20sugarrush/internal"
	"serve/servicepp/pp_vs20sugarrush/internal/gamedata"
	"serve/servicepp/pp_vs20sugarrush/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *ppcomm.Player) error {
		...
		if isEnd {
			...
			plr.OnSpinFinish(costGold, ut.Money2Gold(allWin), plr.IsBuy, false, internal.FreeMultiply1)
