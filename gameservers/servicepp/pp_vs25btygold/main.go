...
import (
	...
	"serve/servicepp/pp_vs25btygold/internal/gamedata"
	"serve/servicepp/pp_vs25btygold/internal/gendata"
	_ "serve/servicepp/pp_vs25btygold/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs25btygold")
