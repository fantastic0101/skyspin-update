...
import (
	"maps"
	"serve/comm/redisx"
	"serve/servicepp/pp_vs1tigers/internal"
	"time"
...
var (
	sampleDoInit = ppcomm.ParseVariables(`def_s=11,11,11,3,4,5,11,11,11&c_paytable=12~any~8,9,10~10,0,0~2&balance=16,668.86&cfgs=2194&reel1=11,8,11,10,11,8,11,6,11,8,11,3,11,9,11,7,11,5,11,9,11,8,11,9,11,8,11,4,11,10,11,8,11,7,11,6&ver=2&reel0=10,11,5,11,8,11,6,8,7,11,3,11,8,11,4,11,9,11,9,11,10,6,11,9&index=1&balance_cash=16,668.86&def_sb=6,7,8&def_sa=11,8,9&reel2=4,11,8,11,10,11,9,11,8,11,6,11,8,11,10,11,9,11,3,11,8,11,10,11,7,11,8,11,10,11,5,11,4,11,7&balance_bonus=0.00&na=s&scatters=1~0,0,0~0,0,0~1,1,1&gmb=0,0,0&rt=d&stime=1737350322740&sa=11,8,9&sb=6,7,8&sc=1.00,2.00,3.00,5.00,10.00,20.00,30.00,45.00,75.00,150.00,300.00,450.00,750.00,1500.00,2250.00,3000.00&defc=10.00&sh=3&wilds=2~0,0,0~1,1,1&bonuses=0&fsbonus=&c=10.00&sver=5&counter=2&ntp=0.00&paytable=0,0,0;0,0,0;0,0,0;500,0,0;300,0,0;200,0,0;100,0,0;80,0,0;50,0,0;30,0,0;20,0,0;0,0,0&l=1&s=11,11,11,3,4,5,11,11,11`)
)
