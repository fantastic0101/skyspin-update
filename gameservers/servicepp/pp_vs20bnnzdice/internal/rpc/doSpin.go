...
import (
	...
	"serve/comm/ut"
	"serve/servicepp/pp_vs20bnnzdice/internal"
	"serve/servicepp/pp_vs20bnnzdice/internal/gamedata"
	"serve/servicepp/pp_vs20bnnzdice/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *ppcomm.Player) error {
		...
		if isEnd {
			...
			plr.OnSpinFinish(costGold, ut.Money2Gold(allWin), plr.IsBuy, false, internal.GetFreeMultiply()[ps.Int("fsp")])
