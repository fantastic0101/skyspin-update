...
import (
	...
	"serve/servicepp/pp_vs20egypttrs/internal"
	"serve/servicepp/pp_vs20egypttrs/internal/gamedata"
	"serve/servicepp/pp_vs20egypttrs/internal/gendata"
	_ "serve/servicepp/pp_vs20egypttrs/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs20egypttrs")
