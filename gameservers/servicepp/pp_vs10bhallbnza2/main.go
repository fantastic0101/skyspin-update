...
import (
	...
	"serve/servicepp/pp_vs10bhallbnza2/internal/gamedata"
	"serve/servicepp/pp_vs10bhallbnza2/internal/gendata"
	_ "serve/servicepp/pp_vs10bhallbnza2/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs10bhallbnza2")
