...
import (
	...
	"serve/servicepp/pp_vs25ultwolgol/internal"
	"serve/servicepp/pp_vs25ultwolgol/internal/gamedata"
	"serve/servicepp/pp_vs25ultwolgol/internal/gendata"
	_ "serve/servicepp/pp_vs25ultwolgol/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs25ultwolgol")
