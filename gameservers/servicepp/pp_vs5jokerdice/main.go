...
import (
	...
	"serve/servicepp/pp_vs5jokerdice/internal/gamedata"
	"serve/servicepp/pp_vs5jokerdice/internal/gendata"
	_ "serve/servicepp/pp_vs5jokerdice/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs5jokerdice")
