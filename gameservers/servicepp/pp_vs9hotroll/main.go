...
import (
	...
	"serve/servicepp/pp_vs9hotroll/internal/gamedata"
	"serve/servicepp/pp_vs9hotroll/internal/gendata"
	_ "serve/servicepp/pp_vs9hotroll/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs9hotroll")
