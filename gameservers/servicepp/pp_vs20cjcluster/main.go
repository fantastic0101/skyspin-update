...
import (
	...
	"serve/servicepp/pp_vs20cjcluster/internal"
	"serve/servicepp/pp_vs20cjcluster/internal/gamedata"
	"serve/servicepp/pp_vs20cjcluster/internal/gendata"
	_ "serve/servicepp/pp_vs20cjcluster/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs20cjcluster")
