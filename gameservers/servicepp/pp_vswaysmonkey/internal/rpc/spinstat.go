...
func init() {
	//mux.RegRpc("/pp_vswaysmonkey/game/spinstat", "spin stat", "stat", spinstat, nil).SetOnlyDev()

	mux.RegRpc("/game-rtp-api/pp_vswaysmonkey/game/spinstat", "spinstat", "game-rtp-api", db.WrapRpcRtpPlayer(playStatistics), nil)
	mux.RegRpc("/game-rtp-api/pp_vswaysmonkey/game/querysimulate", "spinstat", "query-simulate", db.WrapRpcRtpPlayer(QuerySimulate), nil)
