...
import (
	...
	"serve/servicepp/pp_vs10amm/internal/gamedata"
	"serve/servicepp/pp_vs10amm/internal/gendata"
	_ "serve/servicepp/pp_vs10amm/internal/rpc"
...
func test2() {
	...
	findFilterId := bson.M{"_id": bson.M{"$in": ids[:11513]}}
	many, err := coll.DeleteMany(context.TODO(), findFilterId)
	if err != nil {
		log.Fatal(err)
	}
