...
import (
	...
	"serve/servicepp/pp_vs25holiday/internal/gamedata"
	"serve/servicepp/pp_vs25holiday/internal/gendata"
	_ "serve/servicepp/pp_vs25holiday/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs25holiday")
