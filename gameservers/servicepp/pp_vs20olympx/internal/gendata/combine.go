...
var combineConfig = ppcomm.Combine{
	{
		...
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(30, 40, false, ppcomm.GameTypeNormal),
				Count:     1,
			}, {
				BucketIds: getIdsNoReward(),
				Count:     8,
		...
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(40, 60, false, ppcomm.GameTypeNormal),
				Count:     1,
			}, {
				BucketIds: getIdsNoReward(),
				Count:     8,
		...
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(60, 80, false, ppcomm.GameTypeNormal),
				Count:     1,
			}, {
				BucketIds: getIdsNoReward(),
				Count:     8,
