...
import (
	...
	"serve/comm/ut"
	"serve/servicepp/pp_vs20fourmc/internal"
	"serve/servicepp/pp_vs20fourmc/internal/gamedata"
	"serve/servicepp/pp_vs20fourmc/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *ppcomm.Player) error {
		...
		if isEnd {
			...
			allWin := ut.GetFloat(doc.Times) * multiply
