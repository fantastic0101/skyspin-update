...
var combineConfig = ppcomm.Combine{
...

	{
		...
		Name:  "1次小游戏（30，60】+8次不中奖+4次剩余随机",
		Count: 20,
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(30, 60, true),
				Count:     1,
			}, {
				BucketIds: getIdsNoReward(),
				Count:     8,
		...
		Name:  "1次小游戏（60，80】+8次不中奖+4次剩余随机",
		Count: 20,
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(60, 80, true),
				Count:     1,
			}, {
				BucketIds: getIdsNoReward(),
				Count:     8,
...

	{
		...
		Name:  "1次小游戏（20，30】+1次小游戏（30，60】+12次不中奖+4次剩余随机",
		Count: 20,
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(20, 30, true),
		...
		Name:  "1次小游戏（60，80】+1次小游戏（80，100】+12次不中奖+4次剩余随机",
		Count: 20,
		Meta: []ppcomm.CombineMeta{
			{
				BucketIds: GetBucketIds(60, 80, true),
