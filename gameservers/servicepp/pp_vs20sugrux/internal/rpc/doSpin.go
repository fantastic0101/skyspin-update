...
import (
	...
	"serve/comm/ut"
	"serve/servicepp/pp_vs20sugrux/internal"
	"serve/servicepp/pp_vs20sugrux/internal/gamedata"
	"serve/servicepp/pp_vs20sugrux/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	...
	err = db.CallWithPlayer(pid, func(plr *ppcomm.Player) error {
		...
		//App, _ := slotsmongo.Load(slotsmongo.MakeKey(plr.AppID, lazy.ServiceName))
		//plrCs, err := slotsmongo.GetPlayerCs(slotsmongo.MakeKey(plr.AppID, lazy.ServiceName), plr.PID)
		//if err != nil {
		//	slog.Error("doSpin", "GetPlayerCs", err)
		//}
