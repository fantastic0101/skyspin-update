...
import (
	...
	"serve/servicepp/pp_vs10eyestorm/internal"
	"serve/servicepp/pp_vs10eyestorm/internal/gamedata"
	"serve/servicepp/pp_vs10eyestorm/internal/gendata"
	_ "serve/servicepp/pp_vs10eyestorm/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs10eyestorm")
...
func test2() {
	...
	findFilterId := bson.M{"_id": bson.M{"$in": ids[:4813]}}
	many, err := coll.DeleteMany(context.TODO(), findFilterId)
	if err != nil {
		log.Fatal(err)
	}
