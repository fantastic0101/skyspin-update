...
import (
	...
	"serve/servicepp/pp_vs40bigjuan/internal/gamedata"
	"serve/servicepp/pp_vs40bigjuan/internal/gendata"
	_ "serve/servicepp/pp_vs40bigjuan/internal/rpc"
...
func test() {
	...
	for i := 66; i <= 66; i++ {
		...
		//num := int(float64(len(ids)) * 0.8)
		num := int(float64(len(ids)) * 0.5)
		if num != 0 {
