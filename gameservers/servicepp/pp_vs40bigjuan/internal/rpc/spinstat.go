...
func init() {
	//mux.RegRpc("/pp_vs40bigjuan/game/spinstat", "spin stat", "stat", spinstat, nil).SetOnlyDev()

	mux.RegRpc("/game-rtp-api/pp_vs40bigjuan/game/spinstat", "spinstat", "game-rtp-api", db.WrapRpcRtpPlayer(playStatistics), nil)
	mux.RegRpc("/game-rtp-api/pp_vs40bigjuan/game/querysimulate", "spinstat", "query-simulate", db.WrapRpcRtpPlayer(QuerySimulate), nil)
