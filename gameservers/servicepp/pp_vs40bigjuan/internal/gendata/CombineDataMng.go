...
func (mng *CombineDataMng) Next(bet string, WitchBucket int) (playResp *ppcomm.SimulateData, err error) {
	...
	//id, _ = primitive.ObjectIDFromHex("677b581ca33dd037e3092801")
	return findFromSimulate(id)
}
...
func handler() {
	db.DialToMongo("mongodb://myAdmin:myAdminPassword1@54.251.234.111:27017/?authSource=admin", "pp_vs40bigjuan")
	var err error
