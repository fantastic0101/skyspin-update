...
import (
	...
	"serve/servicepp/pp_vs10mayangods/internal"
	"serve/servicepp/pp_vs10mayangods/internal/gamedata"
	"serve/servicepp/pp_vs10mayangods/internal/gendata"
	_ "serve/servicepp/pp_vs10mayangods/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs10mayangods")
