...
import (
	...
	"serve/servicepp/pp_vs20goldfever/internal"
	"serve/servicepp/pp_vs20goldfever/internal/gamedata"
	"serve/servicepp/pp_vs20goldfever/internal/gendata"
	_ "serve/servicepp/pp_vs20goldfever/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs20goldfever")
