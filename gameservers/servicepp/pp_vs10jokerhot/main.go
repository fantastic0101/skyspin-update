...
import (
	...
	"serve/servicepp/pp_vs10jokerhot/internal/gamedata"
	"serve/servicepp/pp_vs10jokerhot/internal/gendata"
	_ "serve/servicepp/pp_vs10jokerhot/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs10jokerhot")
