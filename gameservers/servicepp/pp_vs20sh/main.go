...
import (
	...
	"serve/servicepp/pp_vs20sh/internal/gamedata"
	"serve/servicepp/pp_vs20sh/internal/gendata"
	_ "serve/servicepp/pp_vs20sh/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs20sh")
