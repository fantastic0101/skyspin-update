...
import (
	...
	"serve/servicepp/pp_vswayswildwest/internal"
	"serve/servicepp/pp_vswayswildwest/internal/gamedata"
	"serve/servicepp/pp_vswayswildwest/internal/gendata"
	_ "serve/servicepp/pp_vswayswildwest/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vswayswildwest")
