...
import (
	...
	"serve/servicepp/pp_vs20aladdinsorc/internal"
	"serve/servicepp/pp_vs20aladdinsorc/internal/gamedata"
	"serve/servicepp/pp_vs20aladdinsorc/internal/gendata"
	_ "serve/servicepp/pp_vs20aladdinsorc/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pp_vs20aladdinsorc")
