...
import (
	...
	"serve/comm/ut"
	"serve/servicepp/pp_vs20starlightx/internal"
	"serve/servicepp/pp_vs20starlightx/internal/gamedata"
	"serve/servicepp/pp_vs20starlightx/internal/gendata"
...
func doSpin(msg *nats.Msg) (ret []byte, err error) {
	// action=doSpin&symbol=vs20starlightx&c=0.5&l=20&bl=0&index=2&counter=3&repeat=0&mgckey=AUTHTOKEN@6318b8f52aa27a735236b247dafd0e27037578637940d87ad54250bfeed0e431~stylename@hllgd_hollygod~SESSION@7dbfc452-ef7a-4b14-8069-a857e5dc165b~SN@e9d7b550
