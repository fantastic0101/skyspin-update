...
type CombineDataMng struct {
	...
	superBuyBucketMap3 [][]primitive.ObjectID
	superBuyBuckets3   []primitive.ObjectID
	superBuyBucketMap4 [][]primitive.ObjectID
	superBuyBuckets4   []primitive.ObjectID
	...
	combineDatas_super_buy3 map[string]*ppcomm.CombineDataBuy
	combineDatas_super_buy4 map[string]*ppcomm.CombineDataBuy
...
func (mng *CombineDataMng) NextSuperBuy(bet string) (playResp *ppcomm.SimulateData, err error) {
	mng.mtx.Lock()
...
func (mng *CombineDataMng) NextSuperBuy3(bet string) (playResp *ppcomm.SimulateData, err error) {
	mng.mtx.Lock()
	data := mng.combineDatas_super_buy3[bet]
	if data == nil {
		data = &ppcomm.CombineDataBuy{
			RawSeries: mng.superBuyBuckets3,
		}
		mng.combineDatas_super_buy3[bet] = data
	}
	mng.mtx.Unlock()
...
func (mng *CombineDataMng) NextSuperBuy4(bet string) (playResp *ppcomm.SimulateData, err error) {
	mng.mtx.Lock()
	data := mng.combineDatas_super_buy4[bet]
	if data == nil {
		data = &ppcomm.CombineDataBuy{
			RawSeries: mng.superBuyBuckets4,
		}
		mng.combineDatas_super_buy4[bet] = data
	}
	mng.mtx.Unlock()
...
func (mng *CombineDataMng) GetSuperBuyMinData() (playResp *ppcomm.SimulateData, err error) {
	bucketId := GetSuperBuyMinBucketId()
...
func (mng *CombineDataMng) GetSuperBuyMinData3() (playResp *ppcomm.SimulateData, err error) {
	bucketId := GetSuperBuyMinBucketId3()
	data := mng.superBuyBucketMap3[bucketId]
	id := lo.Sample(data)
	if id == primitive.NilObjectID {
		return nil, errors.New("not found")
	}
...
func (mng *CombineDataMng) GetSuperBuyMinData4() (playResp *ppcomm.SimulateData, err error) {
	bucketId := GetSuperBuyMinBucketId4()
	data := mng.superBuyBucketMap4[bucketId]
	id := lo.Sample(data)
	if id == primitive.NilObjectID {
		return nil, errors.New("not found")
	}
