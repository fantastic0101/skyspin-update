...
import (
	...
	"serve/service/pg_1372643/internal/gamedata"
	"serve/service/pg_1372643/internal/gendata"

	_ "serve/service/pg_1372643/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1372643.http.test")
	if len(httpAddr) != 0 {
