...
func init() {
	mux.RegRpc("/game-api/1372643/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func gameinfo(plr *models.Player, ps define.PGParams, ret *define.M) (err error) {
	...
	s := define.M{
		"fb":    map[string]any{"is": true, "bm": 75, "t": 30 * curItem.Multi},
...
func getInitSi(DefaultCs float64, DefaultBetLevel int64) map[string]any {
	return map[string]any{
		...
		"lw":   nil,
		"lwa":  0,
		"orl":  []int{10, 10, 10, 5, 5, 5, 10, 10, 10, 11, 11, 11, 9, 9, 8, 8, 8, 8, 5, 11, 11, 7, 7, 7, 8, 6, 6, 6, 6, 3, 9, 4, 4, 4, 6, 6},
		"now":  1920,
		"snww": nil,
		"ssaw": 0,
		// "rs":   nil,
		...
		"ml":    DefaultBetLevel,
		"cs":    DefaultCs,
		"rl":    []int{10, 10, 10, 5, 5, 5, 10, 10, 10, 11, 11, 11, 9, 9, 8, 8, 8, 8, 5, 11, 11, 7, 7, 7, 8, 6, 6, 6, 6, 3, 9, 4, 4, 4, 6, 6},
		"sid":   "0",
		"psid":  "0",
		"st":    1,
		"nst":   1,
