...
import (
	...
	"serve/service/pg_1381200/internal/gamedata"
	"serve/service/pg_1381200/internal/gendata"

	_ "serve/service/pg_1381200/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1381200.http.test")
	if len(httpAddr) != 0 {
