...
func init() {
	mux.RegRpc("/game-api/1381200/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func getInitSi(DefaultCs float64, DefaultBetLevel int64) map[string]any {
	return map[string]any{
		...
		"lw":    nil,
		"lwa":   0,
		"orl":   []int{12, 5, 8, 11, 8, 6, 12, 11, 6, 11, 6, 4, 6, 10, 6, 4, 11, 12, 12, 5, 9, 10, 8, 2},
		"now":   1920,
		"snww":  nil,
		"ewl":   []int{0, 0},
		"ssaw":  0,
		...
		"cs":    DefaultCs,
		"rl": []int{
			12, 5, 8, 11, 8, 6, 12, 11, 6, 11, 6, 4, 6, 10, 6, 4, 11, 12, 12, 5, 9, 10, 8, 2},
		"sid":  "0",
		"psid": "0",
		"st":   1,
		"nst":  1,
