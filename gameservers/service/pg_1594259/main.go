// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_1594259 ./service/pg_1594259
package main
...
import (
	...
	"serve/service/pg_1594259/internal/config"
	"serve/service/pg_1594259/internal/gendata"
	_ "serve/service/pg_1594259/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_1594259.http.test")
// 	if len(httpAddr) != 0 {
