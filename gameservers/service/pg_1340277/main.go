// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_1340277 ./service/pg_1340277
package main
...
import (
	...
	"serve/service/pg_1340277/internal/config"
	"serve/service/pg_1340277/internal/gendata"
	_ "serve/service/pg_1340277/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_1340277.http.test")
// 	if len(httpAddr) != 0 {
