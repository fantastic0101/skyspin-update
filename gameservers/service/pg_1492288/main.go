...
import (
	...
	"serve/service/pg_1492288/internal/gamedata"
	"serve/service/pg_1492288/internal/gendata"

	_ "serve/service/pg_1492288/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1492288.http.test")
	if len(httpAddr) != 0 {
