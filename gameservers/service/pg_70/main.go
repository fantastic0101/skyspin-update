// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_70 ./service/pg_70
package main
...
import (
	...
	"serve/service/pg_70/internal/config"
	"serve/service/pg_70/internal/gendata"
	_ "serve/service/pg_70/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_70.http.test")
// 	if len(httpAddr) != 0 {
