// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_62 ./service/pg_62
package main
...
import (
	...
	"serve/service/pg_62/internal/config"
	"serve/service/pg_62/internal/gendata"
	_ "serve/service/pg_62/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_62.http.test")
// 	if len(httpAddr) != 0 {
