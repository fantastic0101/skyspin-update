// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_75 ./service/pg_75
package main
...
import (
	...
	"serve/service/pg_75/internal/config"
	"serve/service/pg_75/internal/gendata"
	_ "serve/service/pg_75/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_75.http.test")
// 	if len(httpAddr) != 0 {
