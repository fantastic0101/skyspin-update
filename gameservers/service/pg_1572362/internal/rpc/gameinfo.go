...
func init() {
	mux.RegRpc("/game-api/1572362/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func getInitSi(DefaultCs float64, DefaultBetLevel int64) map[string]any {
	return map[string]any{
		...
		"lw":  nil,
		"lwa": 0,
		"orl": []int{9, 9, 2, 8, 1, 4, 8, 4, 3, 7, 8, 8, 4, 7, 2, 4, 7, 7, 3},
		"now": 1920,
		// "nowpr": []int{
		// 	4,
		// 	2,
		...
		"cs":    DefaultCs,
		"rl": []int{
			9, 9, 2, 8, 1, 4, 8, 4, 3, 7, 8, 8, 4, 7, 2, 4, 7, 7, 3},
		"sid":  "0",
		"psid": "0",
		"st":   1,
		"nst":  1,
