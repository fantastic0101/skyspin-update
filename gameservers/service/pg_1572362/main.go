...
import (
	...
	"serve/service/pg_1572362/internal/gamedata"
	"serve/service/pg_1572362/internal/gendata"

	_ "serve/service/pg_1572362/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1572362.http.test")
	if len(httpAddr) != 0 {
