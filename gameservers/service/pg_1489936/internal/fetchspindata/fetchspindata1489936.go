...
func main() {
	...
	db.DialToMongo(mongoaddr, "pg_1489936")
...
func normal(i int) {
	uid := fmt.Sprintf("testyy1489936_%d", i)

	pinfo := lo.Must(pg.GetPlayerToken(uid, "1489936"))
...
func game(i int) {
	uid := fmt.Sprintf("testyygame1489936_%d", i)
