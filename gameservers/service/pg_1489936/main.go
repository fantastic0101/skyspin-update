...
import (
	...
	"serve/service/pg_1489936/internal/gamedata"
	"serve/service/pg_1489936/internal/gendata"

	_ "serve/service/pg_1489936/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1489936")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1489936.http.test")
	if len(httpAddr) != 0 {
