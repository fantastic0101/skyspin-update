...
import (
	...
	"serve/service/pg_1543462/internal/gamedata"
	"serve/service/pg_1543462/internal/gendata"

	_ "serve/service/pg_1543462/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1543462.http.test")
	if len(httpAddr) != 0 {
