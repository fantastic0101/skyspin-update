...
func init() {
	mux.RegRpc("/game-api/37/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func gameinfo(plr *models.Player, ps define.PGParams, ret *define.M) (err error) {
	...
	s := define.M{
		"fb":    nil,
		"wt":    define.M{"mw": 2.5, "bw": 5.0, "mgw": 10.0, "smgw": 20.0},
		"maxwm": nil,
