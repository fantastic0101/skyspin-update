...
func (p *Player) UpdatePool(bet int64, selfPoolGold int64, toSelfAwardPool int64, forcedKill bool, app *redisx.AppStore) {
	...
	//	betMul := gamedata.Settings.RewardPercent + slotspool.GetSlotsPool(p.AppID).Value
	//	if rotateCount < 100 {
	//		betMul += gamedata.Settings.RewardPercentLess100
	//	}
...
//func (p *Player) UpdateCurrentRtp() {
//	plr, err := db.GetDocPlayer(p.PID)
//	if err != nil {
//		return
//	}
//	p.CurrentRtp = plr.CurrentRtp
//}
