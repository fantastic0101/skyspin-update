...
import (
	...
	"serve/service/pg_1448762/internal/gamedata"
	"serve/service/pg_1448762/internal/gendata"

	_ "serve/service/pg_1448762/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1448762.http.test")
	if len(httpAddr) != 0 {
