...
func init() {
	mux.RegRpc("/game-api/38/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}

type D = []any

var Cs = []float64{0.1, 1, 5, 25}
...
func gameinfo(plr *models.Player, ps define.PGParams, ret *define.M) (err error) {
	...
	s := define.M{
		"fb":    nil,
		"wt":    define.M{"mw": 2.5, "bw": 10.0, "mgw": 20.0, "smgw": 35.0},
		"maxwm": nil,
