...
import (
	...
	"serve/service/pg_1635221/internal/gamedata"
	"serve/service/pg_1635221/internal/gendata"

	_ "serve/service/pg_1635221/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1635221.http.test")
	if len(httpAddr) != 0 {
