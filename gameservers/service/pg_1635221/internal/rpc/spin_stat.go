...
import (
	...
	"serve/comm/ut"
	"serve/service/pg_1635221/internal/gendata"
...
func init() {
	...
	mux.RegRpc("/game-rtp-api/1635221/game/spinstat", "spinstat", "game-rtp-api", db.WrapRpcRtpPlayer(playStatistics), nil)
	mux.RegRpc("/game-rtp-api/1635221/game/querysimulate", "spinstat", "query-simulate", db.WrapRpcRtpPlayer(QuerySimulate), nil)
