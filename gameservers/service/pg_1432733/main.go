...
import (
	...
	"serve/service/pg_1432733/internal/gamedata"
	"serve/service/pg_1432733/internal/gendata"

	_ "serve/service/pg_1432733/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1432733.http.test")
	if len(httpAddr) != 0 {
