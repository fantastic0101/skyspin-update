...
import (
	...
	"serve/service/pg_1418544/internal/gamedata"
	"serve/service/pg_1418544/internal/gendata"

	_ "serve/service/pg_1418544/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1418544")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1418544.http.test")
	if len(httpAddr) != 0 {
