...
import (
	...
	"serve/service/pg_1513328/internal/gamedata"
	"serve/service/pg_1513328/internal/gendata"

	_ "serve/service/pg_1513328/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1513328")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1513328.http.test")
	if len(httpAddr) != 0 {
