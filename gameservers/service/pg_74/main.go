// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_74 ./service/pg_74
package main
...
import (
	...
	"serve/service/pg_74/internal/config"
	"serve/service/pg_74/internal/gendata"
	_ "serve/service/pg_74/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_74.http.test")
// 	if len(httpAddr) != 0 {
