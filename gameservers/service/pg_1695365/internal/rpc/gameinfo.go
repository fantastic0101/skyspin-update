...
func init() {
	mux.RegRpc("/game-api/1695365/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func gameinfo(plr *models.Player, ps define.PGParams, ret *M) (err error) {
	...
	// }
	// si["mf"] = newMF
	// mfByte, _ := json.Marshal(newMF)
	// fmt.Println("si[mf] is:", string(mfByte))
	*ret = s
