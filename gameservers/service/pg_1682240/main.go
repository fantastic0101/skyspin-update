...
import (
	...
	"serve/service/pg_1682240/internal/gamedata"
	"serve/service/pg_1682240/internal/gendata"

	_ "serve/service/pg_1682240/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1682240")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1682240.http.test")
	if len(httpAddr) != 0 {
