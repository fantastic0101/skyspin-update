...
import (
	...
	"serve/service/pg_1402846/internal/gamedata"
	"serve/service/pg_1402846/internal/gendata"

	_ "serve/service/pg_1402846/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1402846.http.test")
	if len(httpAddr) != 0 {
