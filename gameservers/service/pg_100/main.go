// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_100 ./service/pg_100
package main
...
import (
	...
	"serve/service/pg_100/internal/config"
	"serve/service/pg_100/internal/gendata"
	_ "serve/service/pg_100/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_100.http.test")
// 	if len(httpAddr) != 0 {
