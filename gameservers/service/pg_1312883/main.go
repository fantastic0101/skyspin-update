...
import (
	...
	"serve/service/pg_1312883/internal/gamedata"
	"serve/service/pg_1312883/internal/gendata"

	_ "serve/service/pg_1312883/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1312883.http.test")
	if len(httpAddr) != 0 {
