...
import (
	...
	"serve/service/pg_1648578/internal/gamedata"
	"serve/service/pg_1648578/internal/gendata"

	_ "serve/service/pg_1648578/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1648578.http.test")
	if len(httpAddr) != 0 {
