...
import (
	...
	"serve/service/pg_1623475/internal/gamedata"
	"serve/service/pg_1623475/internal/gendata"

	_ "serve/service/pg_1623475/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1623475.http.test")
	if len(httpAddr) != 0 {
