...
import (
	...
	"serve/comm/ut"
	"serve/service/pg_1623475/internal/gendata"
	"serve/service/pg_1623475/internal/models"
	"strconv"
	"strings"
	"sync"
...
func init() {
	...
	mux.RegRpc("/game-rtp-api/1623475/game/spinstat", "spinstat", "game-rtp-api", db.WrapRpcRtpPlayer(playStatistics), nil)
	mux.RegRpc("/game-rtp-api/1623475/game/querysimulate", "spinstat", "query-simulate", db.WrapRpcRtpPlayer(QuerySimulate), nil)
