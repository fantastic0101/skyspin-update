...
import (
	...
	"serve/service/pg_91/internal/gamedata"
	"serve/service/pg_91/internal/gendata"

	_ "serve/service/pg_91/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_91")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_91.http.test")
	if len(httpAddr) != 0 {
