...
import (
	...
	"serve/service/pg_1671262/internal/gamedata"
	"serve/service/pg_1671262/internal/gendata"

	_ "serve/service/pg_1671262/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1671262.http.test")
	if len(httpAddr) != 0 {
