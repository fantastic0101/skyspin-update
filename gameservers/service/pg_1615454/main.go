...
import (
	...
	"serve/service/pg_1615454/internal/gamedata"
	"serve/service/pg_1615454/internal/gendata"

	_ "serve/service/pg_1615454/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1615454.http.test")
	if len(httpAddr) != 0 {
