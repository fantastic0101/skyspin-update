...
import (
	...
	"serve/service/pg_1568554/internal/gamedata"
	"serve/service/pg_1568554/internal/gendata"

	_ "serve/service/pg_1568554/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1568554")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1568554.http.test")
	if len(httpAddr) != 0 {
