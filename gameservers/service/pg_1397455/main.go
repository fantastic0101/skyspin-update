...
import (
	...
	"serve/service/pg_1397455/internal/gamedata"
	"serve/service/pg_1397455/internal/gendata"

	_ "serve/service/pg_1397455/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1397455.http.test")
	if len(httpAddr) != 0 {
