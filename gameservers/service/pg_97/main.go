...
import (
	...
	"serve/service/pg_97/internal/gamedata"
	"serve/service/pg_97/internal/gendata"

	_ "serve/service/pg_97/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_97")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_97.http.test")
	if len(httpAddr) != 0 {
