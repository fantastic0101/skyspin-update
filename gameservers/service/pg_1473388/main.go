...
import (
	...
	"serve/service/pg_1473388/internal/gamedata"
	"serve/service/pg_1473388/internal/gendata"

	_ "serve/service/pg_1473388/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1473388.http.test")
	if len(httpAddr) != 0 {
