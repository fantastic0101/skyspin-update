...
import (
	...
	"serve/service/pg_1529867/internal/gamedata"
	"serve/service/pg_1529867/internal/gendata"

	_ "serve/service/pg_1529867/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1529867")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1529867.http.test")
	if len(httpAddr) != 0 {
