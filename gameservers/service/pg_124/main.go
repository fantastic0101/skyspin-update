...
import (
	...
	"serve/service/pg_124/internal/gamedata"
	"serve/service/pg_124/internal/gendata"

	_ "serve/service/pg_124/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_124")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_124.http.test")
	if len(httpAddr) != 0 {
