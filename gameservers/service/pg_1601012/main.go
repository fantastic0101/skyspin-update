...
import (
	...
	"serve/service/pg_1601012/internal/gamedata"
	"serve/service/pg_1601012/internal/gendata"

	_ "serve/service/pg_1601012/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1601012")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1601012.http.test")
	if len(httpAddr) != 0 {
