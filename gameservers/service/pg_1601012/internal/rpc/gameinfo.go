...
func init() {
	mux.RegRpc("/game-api/1601012/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func getInitSi(DefaultCs float64, DefaultBetLevel int64) map[string]any {
	return map[string]any{
		...
		"lw":    nil,
		"lwa":   0,
		"orl":   []int{10, 8, 8, 6, 6, 9, 8, 7, 11, 3, 2, 4, 8, 8, 10, 10, 11, 7, 9, 3, 10, 9, 9, 8, 6, 3, 3, 9, 9, 11},
		"now":   1920,
		"snww":  nil,
		"ssaw":  0,
		"rs":    nil,
		...
		"ml":    DefaultBetLevel,
		"cs":    DefaultCs,
		"rl":    []int{10, 8, 8, 6, 6, 9, 8, 7, 11, 3, 2, 4, 8, 8, 10, 10, 11, 7, 9, 3, 10, 9, 9, 8, 6, 3, 3, 9, 9, 11},
		"sid":   "0",
		"psid":  "0",
		"st":    1,
		"nst":   1,
