...
import (
	...
	"serve/service/pg_1555350/internal/gamedata"
	"serve/service/pg_1555350/internal/gendata"

	_ "serve/service/pg_1555350/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1555350.http.test")
	if len(httpAddr) != 0 {
