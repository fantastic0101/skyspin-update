...
import (
	...
	"serve/service/pg_68/internal/gamedata"
	"serve/service/pg_68/internal/gendata"

	_ "serve/service/pg_68/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_68")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_68.http.test")
	if len(httpAddr) != 0 {
