...
import (
	...
	"serve/service/pg_94/internal/gamedata"
	"serve/service/pg_94/internal/gendata"

	_ "serve/service/pg_94/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_94")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_94.http.test")
	if len(httpAddr) != 0 {
