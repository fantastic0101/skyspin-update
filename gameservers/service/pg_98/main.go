...
import (
	...
	"serve/service/pg_98/internal/gamedata"
	"serve/service/pg_98/internal/gendata"

	_ "serve/service/pg_98/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_98")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_98.http.test")
	if len(httpAddr) != 0 {
