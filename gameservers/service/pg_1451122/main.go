...
import (
	...
	"serve/service/pg_1451122/internal/gamedata"
	"serve/service/pg_1451122/internal/gendata"

	_ "serve/service/pg_1451122/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1451122.http.test")
	if len(httpAddr) != 0 {
