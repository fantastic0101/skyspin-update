...
import (
	...
	"serve/service/pg_64/internal/gamedata"
	"serve/service/pg_64/internal/gendata"

	_ "serve/service/pg_64/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_64")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_64.http.test")
	if len(httpAddr) != 0 {
