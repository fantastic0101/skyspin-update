...
import (
	...
	"serve/service/pg_63/internal/gamedata"
	"serve/service/pg_63/internal/gendata"

	_ "serve/service/pg_63/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		//slotsmongo.InitClassData3("simulate")
		slotsmongo.InitData("simulate", "pg_63")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_63.http.test")
	if len(httpAddr) != 0 {
