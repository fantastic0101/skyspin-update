// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_101 ./service/pg_101
package main
...
import (
	...
	"serve/service/pg_101/internal/config"
	"serve/service/pg_101/internal/gendata"
	_ "serve/service/pg_101/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_101.http.test")
// 	if len(httpAddr) != 0 {
