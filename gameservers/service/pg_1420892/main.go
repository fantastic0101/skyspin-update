...
import (
	...
	"serve/service/pg_1420892/internal/gamedata"
	"serve/service/pg_1420892/internal/gendata"

	_ "serve/service/pg_1420892/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1420892.http.test")
	if len(httpAddr) != 0 {
