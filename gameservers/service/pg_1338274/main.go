...
import (
	...
	"serve/service/pg_1338274/internal/gamedata"
	"serve/service/pg_1338274/internal/gendata"

	_ "serve/service/pg_1338274/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1338274.http.test")
	if len(httpAddr) != 0 {
