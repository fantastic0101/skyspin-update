...
import (
	...
	"serve/service/pg_1368367/internal/gamedata"
	"serve/service/pg_1368367/internal/gendata"

	_ "serve/service/pg_1368367/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1368367.http.test")
	if len(httpAddr) != 0 {
