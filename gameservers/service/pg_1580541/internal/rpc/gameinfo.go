...
func init() {
	mux.RegRpc("/game-api/1580541/v2/GameInfo/Get", "gameinfo", "game-api", db.WrapRpcPlayer(gameinfo), nil)
}
...
func gameinfo(plr *models.Player, ps define.PGParams, ret *M) (err error) {
	...
	s := M{
		"fb":    M{"is": true, "bm": 75, "t": 250.0 * curItem.Multi},
		"wt":    M{"mw": 5.0, "bw": 15.0, "mgw": 25.0, "smgw": 50.0},
		"maxwm": 10000,
	...
	// s["ls"] = nil
	s["bl"] = balance
	// ls := M{"si": M{"wp": nil, "lw": nil, "frl": D{6, 4, 5, 4, 0, 2, 6, 3, 4}, "pc": nil, "wm": 10, "tnbwm": nil, "gwt": -1, "fb": nil, "ctw": 0.0, "pmt": nil, "cwc": 0, "fstc": nil, "pcwc": 0, "rwsp": nil, "hashr": "0:4;0;3#MV#50#MT#1#MG#0#", "ml": 5, "cs": 10.0, "rl": D{4, 0, 3}, "sid": "17671580541951580541281610240", "psid": "17671580541951580541281610240", "st": 1, "nst": 1, "pf": 1, "aw": 0.00, "wid": 0, "wt": "C", "wk": "0_C", "wbn": nil, "wfg": nil, "blb": balance + 50, "blab": balance, "bl": balance, "tb": 50.00, "tbb": 50.00, "tw": 0.00, "np": -50.00, "ocr": nil, "mr": nil, "ge": D{1, 11}}}
