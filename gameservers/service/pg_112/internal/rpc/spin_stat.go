...
import (
	...
	"serve/comm/ut"
	"serve/service/pg_112/internal/gendata"
	"serve/service/pg_112/internal/models"
	"strconv"
	"strings"
	"sync"
...
func init() {
	...
	mux.RegRpc("/game-rtp-api/112/game/spinstat", "spinstat", "game-rtp-api", db.WrapRpcRtpPlayer(playStatistics), nil)
	mux.RegRpc("/game-rtp-api/112/game/querysimulate", "spinstat", "query-simulate", db.WrapRpcRtpPlayer(QuerySimulate), nil)
