...
import (
	...
	"serve/service/pg_1508783/internal/gamedata"
	"serve/service/pg_1508783/internal/gendata"

	_ "serve/service/pg_1508783/internal/rpc"
...
func main() {
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1508783.http.test")
	if len(httpAddr) != 0 {
