...
import (
	...
	"serve/service/pg_1717688/internal/gamedata"
	"serve/service/pg_1717688/internal/gendata"

	_ "serve/service/pg_1717688/internal/rpc"
...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "cache" {
		slotsmongo.InitData("simulate", "pg_1717688")
	...
	httpAddr, _ := lazy.RouteFile.Get("pg_1717688.http.test")
	if len(httpAddr) != 0 {
