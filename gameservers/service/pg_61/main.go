// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/pg_61 ./service/pg_61
package main
...
import (
	...
	"serve/service/pg_61/internal/config"
	"serve/service/pg_61/internal/gendata"
	_ "serve/service/pg_61/internal/rpc"
...
// 	httpAddr, _ := lazy.RouteFile.Get("pg_61.http.test")
// 	if len(httpAddr) != 0 {
