...
func (s *service) highLowState(state int, rtpDrb *PSF_ON_00002_1.DrbMath) (rtpState, rtpGroupId int) {
...
func (s *service) rngHighRtpGroupId(rtpDrb *PSF_ON_00002_1.DrbMath) int {
...
func (s *service) rngLowRtpGroupId(rtpDrb *PSF_ON_00002_1.DrbMath) int {
