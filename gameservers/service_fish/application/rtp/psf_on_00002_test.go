...
const gameId_00002 = models.PSF_ON_00002

var mathModuleId_00002 string

func TestService_00002_Calc(t *testing.T) {
	...
	var rtpLow_redenvelop_20 uint64 = 0 // Hot Pot hit Low redEnvelop
	...
	var rtpLow_redenvelop_26 uint64 = 0
	var rtpLow_redenvelop_27 uint64 = 0
	...
	var rtpHigh_redenvelop_20 uint64 = 0
	...
	var rtpHigh_redenvelop_26 uint64 = 0
	var rtpHigh_redenvelop_27 uint64 = 0
	...
	switch rtpId {
	case 95:
		mathModuleId_00002 = models.PSFM_00003_95_1
	case 96:
		mathModuleId_00002 = models.PSFM_00003_96_1
	case 97:
		mathModuleId_00002 = models.PSFM_00003_97_1
	case 98:
		mathModuleId_00002 = models.PSFM_00003_98_1
	}
	run_times = run_times * 10000

	for i := 0; i < run_times; i++ {
		Service.Decrease(gameId_00002, 0, mathModuleId_00002, secWebSocketKey, BET)

		rtpState := Service.RtpState(secWebSocketKey, gameId_00002, subgameId)

		rtpId := Service.RtpId(secWebSocketKey, gameId_00002, -1)
		...
		result := probability.Service.Calc(
			...
			fishId,
			-1,
			Service.RtpBudget(secWebSocketKey, gameId_00002, -1, mathModuleId_00002),
			0,
		)
		...
		case 20:
			...
			if result.ExtraTriggerBonus != nil { // same time hit fish and Envelop
				result := probability.Service.Calc(
					gameId_00002,
					mathModuleId_00002,
					strconv.Itoa(result.BonusTypeId),
				...
				switch rtpState {
				case high:
					rtpHigh_redenvelop_20 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
				case low:
					rtpLow_redenvelop_20 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
				default:
					t.Fatal("RTP State Error")
				}
			} else { // only hit Envelop
				if result.TriggerIconId == 31 {
					result := probability.Service.Calc(
						gameId_00002,
						mathModuleId_00002,
		...
		case 26:
			...
			case high:
				if result.Pay > 0 {
					...
					if result.ExtraTriggerBonus != nil {
						...
						switch rtpState {
						case high:
							rtpHigh_redenvelop_26 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
						case low:
							rtpLow_redenvelop_26 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
						default:
							t.Fatal("RTP State Error")
						}
					}
					rtpHigh_fish_26 += shot_26(gameId_00002, mathModuleId_00002, PSFM_00003_98_1.RTP98BS.PSF_ON_00002_1_BsMath.Icons.Drill.RTP8.ID, result.BonusPayload.(int))
					rtpHigh_win_26++
				}
				rtpHigh_hit_26++
			...
			case low:
				if result.Pay > 0 {
					...
					rtpLow_fish_26 += shot_26(gameId_00002, mathModuleId_00002, PSFM_00003_98_1.RTP98BS.PSF_ON_00002_1_BsMath.Icons.Drill.RTP8.ID, result.BonusPayload.(int))
					rtpLow_win_26++
				}
				rtpLow_hit_26++
		...
		case 27:
			switch rtpState {
			case high:
				if result.Pay > 0 { // hit machine Gun
					...
					if result.ExtraTriggerBonus != nil {
						...
						switch rtpState {
						case high:
							rtpHigh_redenvelop_27 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
						case low:
							rtpLow_redenvelop_27 += uint64(result.BonusPayload.([]int)[rngRedEnvelope()])
						default:
							t.Fatal("RTP State Error")
						}
					}
					rtpHigh_fish_27 += shot_27(gameId_00002, mathModuleId_00002, PSFM_00003_98_1.RTP98BS.PSF_ON_00002_1_BsMath.Icons.MachineGun.RTP8.ID, result.BonusPayload.(int))
			...
			case low:
				if result.Pay > 0 {
					...
					rtpLow_fish_27 += shot_27(gameId_00002, mathModuleId_00002, PSFM_00003_98_1.RTP98BS.PSF_ON_00002_1_BsMath.Icons.MachineGun.RTP8.ID, result.BonusPayload.(int))
					rtpLow_win_27++
				}
				rtpLow_hit_27++
	...
	rtpLow_redenvelop := rtpLow_redenvelop_0 + rtpLow_redenvelop_1 + rtpLow_redenvelop_2 + rtpLow_redenvelop_3 + rtpLow_redenvelop_4 + rtpLow_redenvelop_5 +
		...
		rtpLow_redenvelop_21 + rtpLow_redenvelop_22 + rtpLow_redenvelop_23 + rtpLow_redenvelop_24 + rtpLow_redenvelop_25 + rtpLow_redenvelop_26 + rtpLow_redenvelop_27
	...
	rtpHigh_redenvelop := rtpHigh_redenvelop_0 + rtpHigh_redenvelop_1 + rtpHigh_redenvelop_2 + rtpHigh_redenvelop_3 + rtpHigh_redenvelop_4 + rtpHigh_redenvelop_5 +
		...
		rtpHigh_redenvelop_21 + rtpHigh_redenvelop_22 + rtpHigh_redenvelop_23 + rtpHigh_redenvelop_24 + rtpHigh_redenvelop_25 + rtpLow_redenvelop_26 + rtpLow_redenvelop_27
	...
	fmt.Println(26, ":", rtpLow_win_26, rtpLow_hit_26, rtpHigh_win_26, rtpHigh_hit_26, rtpLow_fish_26, rtpHigh_fish_26,
		getRate(rtpLow_win_26, rtpLow_hit_26), getRate(rtpLow_fish_26+rtpLow_redenvelop_26, rtpLow_hit_26),
		getRate(rtpHigh_win_26, rtpHigh_hit_26), getRate(rtpHigh_fish_26+rtpHigh_redenvelop_26, rtpHigh_hit_26),
	...
	fmt.Println(27, ":", rtpLow_win_27, rtpLow_hit_27, rtpHigh_win_27, rtpHigh_hit_27, rtpLow_fish_27, rtpHigh_fish_27,
		getRate(rtpLow_win_27, rtpLow_hit_27), getRate(rtpLow_fish_27+rtpLow_redenvelop_27, rtpLow_hit_27),
		getRate(rtpHigh_win_27, rtpHigh_hit_27), getRate(rtpHigh_fish_27+rtpHigh_redenvelop_27, rtpHigh_hit_27),
