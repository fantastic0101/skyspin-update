...
func psf_on_00007_HitBullet(action *flux.Action, am *AccountingManager) {
	psf_on_00004_HitBullet(action, am)
}

func psf_on_00007_Bonus(action *flux.Action, am *AccountingManager) {
...
func psf_on_00007_RefundBonusBullet(action *flux.Action, am *AccountingManager) {
	psf_on_00004_RefundBonusBullet(action, am)
}

func psf_on_00007_CheckBulletTypeId(bulletId, restBullets int32,
...
func psf_on_00007_BulletHit(bulletId int32,
...
func psf_on_00007_BulletHit_TriggerId(triggerIconId int,
	am *AccountingManager,
	hitBullet *bullet.Bullet,
...
func psf_on_00007_BulletBonus(bonusBulletId int32, bonusBullet *bullet.Bullet, machineGunUuid, superMachineGunUuid map[string]map[uint64]int32, bonusBulletShooted map[string]map[string]map[uint64]int32) {
