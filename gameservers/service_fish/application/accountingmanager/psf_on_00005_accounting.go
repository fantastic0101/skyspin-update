...
func psf_on_00005_HitBullet(action *flux.Action, am *AccountingManager) {
	psf_on_00004_HitBullet(action, am)
}

func psf_on_00005_Bonus(action *flux.Action, am *AccountingManager) {
	psf_on_00004_Bonus(action, am)
}

func psf_on_00005_RefundBonusBullet(action *flux.Action, am *AccountingManager) {
	psf_on_00004_RefundBonusBullet(action, am)
}

func psf_on_00005_CheckBulletTypeId(bulletId, restBullets int32,
...
func psf_on_00005_BulletHit(bulletId int32,
...
func psf_on_00005_BulletHit_TriggerId(triggerIconId int,
	am *AccountingManager,
	hitBullet *bullet.Bullet,
...
func psf_on_00005_BulletBonus(bonusBulletId int32, bonusBullet *bullet.Bullet, machineGunUuid, superMachineGunUuid map[string]map[uint64]int32, bonusBulletShooted map[string]map[string]map[uint64]int32) {
