...
func (s *service) setBetAndRateAvailableGame(gameId, mathId, rate, bet string, st *gameSetting) {
	game := &hostFishGame{
		MathId:           mathId,
		GameId:           gameId,
		SubGameId:        0,
...
func (s *service) setDefaultAvailableGame(gameId, mathId string, st *gameSetting) {
	game := &hostFishGame{
		MathId:           mathId,
		GameId:           gameId,
		SubGameId:        0,
