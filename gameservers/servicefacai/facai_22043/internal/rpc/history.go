...
//
//func init() {
//	facaicomm.RegRpc("/gs2c/api/history/v2/play-session/last-items", history_last_items)
//	facaicomm.RegRpc("/gs2c/api/history/v3/action/children", history_children)
//	facaicomm.RegRpc("/gs2c/api/history/v2/play-session/by-round", history_by_round)
//}
...
//	ps := facaicomm.ParseVariables(string(msg.Data))
...
//	var docs []*facaicomm.RspHistoryData
//
...
//	coll := db.Collection("BetHistory")
//	var doc struct {
//		RoundDetails []*facaicomm.HistoryDetailsData `bson:"rounddetails"`
//	}
...
//	id := ps.Str("id")
//	coll := db.Collection("BetHistory")
//	var doc *facaicomm.RspHistoryData
//	//if false {
