...
import SlotPanTuZi from "./SlotPan_TuZi.vue";
...
let updateData = () => {
    ...
    if (props.PlayResp && props.PlayResp.DropPan) {
        props.PlayResp.DropPan.forEach((v,index) => {
            /*if (isStartGame) {
                v.free = true
            }*/
            v['value'] = index
