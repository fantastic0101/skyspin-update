                ...
                <template v-if="typeof imgId === 'object'">
                    <template v-if="imgId.nums === 11">
                        <template v-if="imgId.findNum">
                            ...
                            <img v-if="imgId.urls === 4" :src="img5"  alt=""/>
...
import img1 from '@/assets/OlympusMap1000/Tumble0.png'
import img2 from '@/assets/OlympusMap1000/Tumble1.png'
import img3 from '@/assets/OlympusMap1000/Tumble2.png'
import img4 from '@/assets/OlympusMap1000/Tumble3.png'
import img5 from '@/assets/OlympusMap1000/Tumble4.png'
/*interface Props {
    Pan: number[][]// 盘面
