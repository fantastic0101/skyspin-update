...
import img1 from '@/assets/OlympusMap/Tumble0.png'
import img2 from '@/assets/OlympusMap/Tumble1.png'
import img3 from '@/assets/OlympusMap/Tumble2.png'
import img4 from '@/assets/OlympusMap/Tumble3.png'
/*interface Props {
    Pan: number[][]// 盘面
