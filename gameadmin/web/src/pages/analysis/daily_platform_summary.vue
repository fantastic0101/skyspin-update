        ...
        <div class="page_table_context">
            ...
            >
                ...
                <template #playersWinLose="scope">
                    <el-text :type="scope.scope.playersWinLose < 0 ? 'danger' : 'success'" size="small">{{ ut.toNumberWithComma(scope.scope.playersWinLose) }}</el-text>

                </template>

                <template #companyWinsLoses="scope">

                    <el-text :type="scope.scope.companyWinsLoses < 0 ? 'danger' : 'success'" size="small">{{ ut.toNumberWithComma(scope.scope.companyWinsLoses) }}</el-text>
                ...
                <template #GGR="scope">
                    <el-text :type="scope.scope.GGR < 0 ? 'danger' : 'success'" size="small">{{ ut.toNumberWithComma(scope.scope.GGR) }}</el-text>
...
let tableHeader = [
    { label: "投注日期", value: "Date", format:(row)=> ut.fmtDate(row.Date, "YYYY-MM-DD"), width: "150px"},
    { label: "商户AppID", value: "AppID", width: "150px"},

    { label: "玩家数量", value: "LoginPlrCount", sortable:true, width: "150px"},
    { label: "新玩家数量", value: "RegistPlrCount", sortable:true, width: "150px"},
    { label: "投注次数", value: "SpinCount", sortable:true, width: "150px"},
    { label: "投注金额", value: "BetAmount", type: "custom", sortable:true, width: "150px"},
    { label: "总赢分", value: "WinAmount", type: "custom", sortable:true, width: "150px"},
    { label: "玩家输赢", value: "playersWinLose", type: "custom", sortable:true, width: "150px"},
    { label: "公司输赢", value: "companyWinsLoses", type: "custom", sortable:true, width: "150px"},
    { label: "公司输赢占比", value: "companyProportion", type: "custom", sortable:true, width: "150px"},
    { label: "合作模式", value: "CooperationType"},
    { label: "平台费", value: "GGR", type: "custom", sortable:true, width: "150px"},
