        ...
        <div class="page_table_context">
            ...
            >
                ...
                <template #handleTools="scope">
                    <el-space>
                        <upload-excel @uploadFile="resolveData" fileName="每月平台汇总"></upload-excel>
                ...
                <template #GGR="scope">
                    <el-text :type="scope.scope.GGR >= 0 ? 'success' : 'danger'">
                        {{ ut.toNumberWithComma(scope.scope.GGR * 1e4) }}
                    </el-text>
...
const generatorExcel = (data) => {
    ...
    excel.DataGeneratorExcel(generatorHeader, uiData.tableDataSlice, `每月平台汇总`)
}
