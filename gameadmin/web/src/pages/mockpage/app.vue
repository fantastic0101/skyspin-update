        ...
        <customTable
            ...
            <template #handleTools="scope">
                ...
                <el-space>
                    ...
                    <upload-excel @uploadFile="resolveData" file-name="产品数据"/>
            ...
            <template #shouyi="scope">
                <el-text :type="scope.scope.shouyi >= 0 ? 'success' : 'danger'">
                    {{ ut.toNumberWithCommaNormal(ut.fmtGold(scope.scope.shouyi * 1e4)) }}
                </el-text>
            </template>
            ...
            <template #huibao="scope">
                ...
                {{ percentFormatter(0,0, scope.scope.huibao) }}
...
import { AdminAnalysis } from '@/api/gamepb/analysis';
...
const resolveData = (data) => {
    ...
    tableHeaderMap.value["游戏厂商"] = "GameManufacturerName"
    tableHeaderMap.value["游戏图标"] = "GameIcon"
