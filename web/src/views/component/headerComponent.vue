            ...
            <el-col :span="20" :offset="2">
                <div class="pageHeader--container">
                    ...
                    <div class="logo_container">
                        <el-image :src="Logo" style="height: 35px">
                ...
                <div class="pageHeader--container">
                    ...
                    <div class="pageHeader--operation">
                        ...
                        <span class="header-icon-item" @click="changeSearchStatus">
                            <el-image :src="SearchIcon" fit="fill" style="width: 25px" :style="{opacity:RTPVisible ? '0.3': null}">
                                         <template #placeholder>
                                            <div></div>
                                        </template>
                            </el-image>
                        </span>
                        <span class="header-icon-item" @click="openFilterDraw" :style="{opacity:RTPVisible ? '0.3': null}">
...
const emit = defineEmits(["openLanguageConfigDialog", "openLinkConfigDialog", "openConnectConfigDialog", "openFilterConfigDraw", "searchGameByName", "manuPosition", "changeFilterView"])
