...
redirectOutput;UHTConsole.AllowToWrite(UHTConsole.wasAllowedToWrite)}};UHTConsole.FormatDate=function(d){var date=d.toJSON().split("T")[0];var time=d.toTimeString().split(" ")[0].replace(/:/g,"-");return[date,time].join("_")};var Loader={};Loader.WURFLProcessed=false;Loader.statisticsURL=null;Loader.statistics=null;
...
Loader.LoadWURFL=function(){var wurflURL=location.protocol+"//device.pragmaticplay.net/wurfl.js";if(location.hostname.indexOf("ppgames.net")!=-1)wurflURL=location.protocol+"//device.ppgames.net/wurfl.js";wurflRequest=new XMLHttpRequest;wurflRequest.onreadystatechange=function(){if(wurflRequest.readyState==4)if(wurflRequest.status==200){var script=document.createElement("script");script.innerHTML=wurflRequest.responseText+"\r\n//# sourceURL="+wurflURL;document.head.appendChild(script);Loader.WURFLLoadHandler()}else Loader.WURFLErrorHandler()};
wurflRequest.open("GET",wurflURL,true);wurflRequest.send();setTimeout(Loader.WURFLErrorHandler,2E3)};
Loader.WURFLLoadHandler=function(){if(Loader.WURFLProcessed)return;Loader.WURFLProcessed=true;var WURFL=window["WURFL"]||null;if(WURFL==null){setTimeout(Loader.WURFLLoadHandler,10);return}if(WURFL.complete_device_name!=undefined)for(var id in LowEndDeviceIdentifiers)if(WURFL.complete_device_name.indexOf(LowEndDeviceIdentifiers[id])>=0){UHT_LOW_END_DEVICE=true;break}console.log("WURFL loaded");UHT_DEVICE_TYPE={MOBILE:WURFL.is_mobile,DESKTOP:!WURFL.is_mobile};Loader.SetExtraInfo();Loader.SendStatistics(JSON.stringify(WURFL))};
Loader.WURFLErrorHandler=function(){if(wurflRequest!=null)wurflRequest.abort();if(Loader.WURFLProcessed)return;Loader.WURFLProcessed=true;console.log("WURFL not loaded use UAParser2");var device=UHT_UA_INFO.device;var mobile=device.type=="mobile"||device.type=="tablet";UHT_DEVICE_TYPE={MOBILE:mobile,DESKTOP:!mobile};Loader.SetExtraInfo();Loader.SendStatistics(JSON.stringify({}))};
...
Loader.SendStatistics=function(params){if(Loader.statisticsURL==null){Loader.statistics=params;return}var xhr=new XMLHttpRequest;xhr.open("POST",Loader.statisticsURL+"&channel="+(UHT_CONFIG.MINI_MODE?"mini":"")+(UHT_DEVICE_TYPE.MOBILE?"mobile":"desktop")+(UHT_CONFIG.LOBBY_LAUNCHED?"_mini_lobby":""),true);xhr.setRequestHeader("Content-type","application/json");xhr.send(params)};if(location.href.indexOf("WURFL_NOT_ALLOWED")>-1)Loader.WURFLErrorHandler();else setTimeout(Loader.LoadWURFL,0);
window.onload=Loader.Start;var UHTLogoIsVisible=true;var UHTLogotype={};UHTLogotype.name=null;UHTLogotype.path=null;UHTLogotype.data=null;UHTLogotype.logoEl=null;UHTLogotype.logoImg=null;UHTLogotype.timer=-1;UHTLogotype.duration=2E3;UHTLogotype.gameLoadingStarted=false;UHTLogotype.hideLogoTimeout=null;
...
<style>
    #pplogo
    {
        ...
        background-image: url('data:image/png;base64,');
    }
    #ScaleRootLoading
    {
        z-index: 2;
...
<script type="text/javascript" src="https://assets.{{MAINHOST}}/gs2c/common/js/html5-script-external.js"></script>
    <script type="text/javascript">

        function TotoDec(b) {
            let a = atob(b);
            var utf8 = unescape(encodeURIComponent(a));
        ...
        Html5GameManager.init({
            ...
            gameConfig: `{
                ...
                "styleName": "win886_win88bt6",
                "SETTINGS": "/gs2c/saveSettings.do",
                "openHistoryInTab": false,
                "replaySystemUrl": "https://pragmaticreplay.{{MAINHOST}}",
                "multiProductMiniLobby": true,
                "ingameLobbyApiURL": "/gs2c/minilobby/games",
                ...
                "currency": "R$",
                "lang": "pt",
                "datapath": "https://assets.{{MAINHOST}}/gs2c/common/v2/games-html5/games/vs/{{SYMBOL}}/",
                "amountType": "COINS_V2",
                "LOGOUT": "/gs2c/logout.do",
                "REGULATION": "/gs2c/regulation/process.do?symbol\u003d{{SYMBOL}}",
                "datapath_alternative": "https://assets.{{MAINHOST}}/gs2c/common/v2/games-html5/games/vs/{{SYMBOL}}/",
                "replaySystemContextPath": "/ReplayService",
                "sessionKey": [
                    "FnMvVxFQz12mcJZZJhYxwXoYCDaRy+EIv/eF06227ajHn6Ad+SYbRJp4JP48ikRdZMX4nk8HP+u+2AK/W97rug\u003d\u003d",
                    "LvHaPMyBM30v8PNamu1uTQ\u003d\u003d",
                    "\u003d\u003d"
                ],
                "showRealCash": "1",
                ...
                "clock": "0",
                "mgckey": "{{AUTHTOKEN}}",
                "gameService": "https://pragmaticplay.{{MAINHOST}}/gs2c/v3/gameService",
                "brandRequirements": "MINSPINBET:80000~!IDR,MINSPINBET:80~!IDR2,NODEC~!IDR,BBB,RUM",
                "gameVerificationURL": "" ,
                "RELOAD_BALANCE": "/gs2c/reloadBalance.do",
                "currencyOriginal": "BRL",
                "extend_events": "1",
                "sessionTimeout": "30",
                "CLOSE_GAME": "/gs2c/closeGame.do?symbol\u003d{{SYMBOL}}",
                "region": "Asia",
                "sessionKeyV2": [
                    "E4xRhEH2FGQhecY+1zMO/Ycdt+MHkfBLTWxy1x7mN0w0vf2Y0ejCsfCXBOGhPTWOChxtkF6NpHUPDMKkYo2NeMn3+5k/4nkeiamnEHJR4dyvBKdXmsDw5z+MuccEm3ma3mO4zKPIIAEXbktXPo9EBbg61d8bvzZCWfUX5FT3WKg\u003d",
                    "I6ZgakURMKnGfVZXQ13etXWpZmvp5KmzNv65bL2Tlr0ugVkwyZdJB0Sfm1rSf/uBFCS+F65R/wsez7xvkxUIOr1Dtz0cOw5y5Txe9ETJK5IryjGBubbBJeYw4GTBSeQ8CCoZBgtXvClpz2xrCbQXZDV+h6r1aPcRg7abWndUPEY\u003d"
                ],
                "HISTORY": "/gs2c/lastGameHistory.do?symbol\u003d{{SYMBOL}}\u0026mgckey\u003d{{AUTHTOKEN}}"
            }`,
            mgckey: "{{AUTHTOKEN}}",
            jurisdictionMsg: "",
            extendSessionUrl: "",
